...
ifeq ($(CONFIG_ESP32S3_SECURE_BOOT),y)
	...
	$(Q) { \
		...
		$(if $(CONFIG_ESP32S3_EFUSE_WRRD_CLOSE),$(call cfg_en,CONFIG_ESP32S3_EFUSE_WRRD_CLOSE)) \
		...
		$(if $(CONFIG_ESP32S3_SECURE_FLASH_ENC_ENABLED),$(call cfg_en,CONFIG_SECURE_FLASH_ENC_ENABLED)) \
		$(if $(CONFIG_ESP32S3_SECURE_FLASH_UART_BOOTLOADER_ALLOW_ENC),$(call cfg_en,CONFIG_SECURE_FLASH_UART_BOOTLOADER_ALLOW_ENC)) \
		$(if $(CONFIG_ESP32S3_SECURE_FLASH_UART_BOOTLOADER_ALLOW_CACHE),$(call cfg_en,CONFIG_SECURE_FLASH_UART_BOOTLOADER_ALLOW_CACHE)) \
		$(if $(CONFIG_ESP32S3_SECURE_FLASH_SKIP_WRITE_PROTECTION_CACHE),$(call cfg_en,CONFIG_SECURE_FLASH_SKIP_WRITE_PROTECTION_CACHE)) \
	} > $(BOOTLOADER_CONFIG)
