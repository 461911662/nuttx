...
#define BOSS1_ESP32S3_FIFO_SIZE       (1280)
#define BOSS1_ESP32S3_FIFO_WORDS      (BOSS1_ESP32S3_FIFO_SIZE >> 2)

/* EP0 + additional EP */

#define BOSS1_ESP32S3_ENDPOINT_NUM    (CONFIG_BOSS1_ESP32S3_OTG_ENDPOINT_NUM + 1)
...
#define BOSS1_ESP32S3_TXFIFO_SIZE \
  (BOSS1_ESP32S3_FIFO_SIZE / 2 / BOSS1_ESP32S3_ENDPOINT_NUM * BOSS1_ESP32S3_ENDPOINT_NUM)

#define BOSS1_ESP32S3_EP_TXFIFO_SIZE \
  (BOSS1_ESP32S3_TXFIFO_SIZE / BOSS1_ESP32S3_ENDPOINT_NUM)

/* EP0 must exist */

#ifdef CONFIG_USBDEV_EP0_TXFIFO_SIZE
#  define BOSS1_ESP32S3_EP0_TXFIFO_SIZE CONFIG_USBDEV_EP0_TXFIFO_SIZE
#else
#  define BOSS1_ESP32S3_EP0_TXFIFO_SIZE BOSS1_ESP32S3_EP_TXFIFO_SIZE
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 1
#  ifdef CONFIG_USBDEV_EP1_TXFIFO_SIZE
#    define BOSS1_ESP32S3_EP1_TXFIFO_SIZE CONFIG_USBDEV_EP1_TXFIFO_SIZE
#  else
#    define BOSS1_ESP32S3_EP1_TXFIFO_SIZE BOSS1_ESP32S3_EP_TXFIFO_SIZE
#  endif
#else
#  define BOSS1_ESP32S3_EP1_TXFIFO_SIZE 0
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 2
#  ifdef CONFIG_USBDEV_EP2_TXFIFO_SIZE
#    define BOSS1_ESP32S3_EP2_TXFIFO_SIZE CONFIG_USBDEV_EP2_TXFIFO_SIZE
#  else
#    define BOSS1_ESP32S3_EP2_TXFIFO_SIZE BOSS1_ESP32S3_EP_TXFIFO_SIZE
#  endif
#else
#  define BOSS1_ESP32S3_EP2_TXFIFO_SIZE 0
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 3
#  ifdef CONFIG_USBDEV_EP3_TXFIFO_SIZE
#    define BOSS1_ESP32S3_EP3_TXFIFO_SIZE CONFIG_USBDEV_EP3_TXFIFO_SIZE
#  else
#    define BOSS1_ESP32S3_EP3_TXFIFO_SIZE BOSS1_ESP32S3_EP_TXFIFO_SIZE
#  endif
#else
#  define BOSS1_ESP32S3_EP3_TXFIFO_SIZE 0
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 4
#  ifdef CONFIG_USBDEV_EP4_TXFIFO_SIZE
#    define BOSS1_ESP32S3_EP4_TXFIFO_SIZE CONFIG_USBDEV_EP4_TXFIFO_SIZE
#  else
#    define BOSS1_ESP32S3_EP4_TXFIFO_SIZE BOSS1_ESP32S3_EP_TXFIFO_SIZE
#  endif
#else
#  define BOSS1_ESP32S3_EP4_TXFIFO_SIZE 0
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 5
#  ifdef CONFIG_USBDEV_EP5_TXFIFO_SIZE
#    define BOSS1_ESP32S3_EP5_TXFIFO_SIZE CONFIG_USBDEV_EP5_TXFIFO_SIZE
#  else
#    define BOSS1_ESP32S3_EP5_TXFIFO_SIZE BOSS1_ESP32S3_EP_TXFIFO_SIZE
#  endif
#else
#  define BOSS1_ESP32S3_EP5_TXFIFO_SIZE 0
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 6
#  ifdef CONFIG_USBDEV_EP6_TXFIFO_SIZE
#    define BOSS1_ESP32S3_EP6_TXFIFO_SIZE CONFIG_USBDEV_EP6_TXFIFO_SIZE
#  else
#    define BOSS1_ESP32S3_EP6_TXFIFO_SIZE BOSS1_ESP32S3_EP_TXFIFO_SIZE
#  endif
#else
#  define BOSS1_ESP32S3_EP6_TXFIFO_SIZE 0
#endif
...
#define BOSS1_ESP32S3_EP0_TXFIFO_WORDS (ALIGN(BOSS1_ESP32S3_EP0_TXFIFO_SIZE, 4) >> 2)
#define BOSS1_ESP32S3_EP1_TXFIFO_WORDS (ALIGN(BOSS1_ESP32S3_EP1_TXFIFO_SIZE, 4) >> 2)
#define BOSS1_ESP32S3_EP2_TXFIFO_WORDS (ALIGN(BOSS1_ESP32S3_EP2_TXFIFO_SIZE, 4) >> 2)
#define BOSS1_ESP32S3_EP3_TXFIFO_WORDS (ALIGN(BOSS1_ESP32S3_EP3_TXFIFO_SIZE, 4) >> 2)
#define BOSS1_ESP32S3_EP4_TXFIFO_WORDS (ALIGN(BOSS1_ESP32S3_EP4_TXFIFO_SIZE, 4) >> 2)
#define BOSS1_ESP32S3_EP5_TXFIFO_WORDS (ALIGN(BOSS1_ESP32S3_EP5_TXFIFO_SIZE, 4) >> 2)
#define BOSS1_ESP32S3_EP6_TXFIFO_WORDS (ALIGN(BOSS1_ESP32S3_EP6_TXFIFO_SIZE, 4) >> 2)

#define BOSS1_ESP32S3_RXFIFO_WORDS  \
  (BOSS1_ESP32S3_FIFO_WORDS       - \
   BOSS1_ESP32S3_EP0_TXFIFO_WORDS - \
   BOSS1_ESP32S3_EP1_TXFIFO_WORDS - \
   BOSS1_ESP32S3_EP2_TXFIFO_WORDS - \
   BOSS1_ESP32S3_EP3_TXFIFO_WORDS - \
   BOSS1_ESP32S3_EP4_TXFIFO_WORDS - \
   BOSS1_ESP32S3_EP5_TXFIFO_WORDS - \
   BOSS1_ESP32S3_EP6_TXFIFO_WORDS)

#if (BOSS1_ESP32S3_RXFIFO_WORDS * 4) < 64
#  error "ESP32-S3 OTG device RX FIFO size should >= 64"
#endif

/* EP0 max packet size */

#define BOSS1_ESP32S3_CDCACM_EP0MAXPACKET CONFIG_CDCACM_EP0MAXPACKET
...
#define BOSS1_ESP32S3_TRACEERR_ALLOCFAIL          0x01
#define BOSS1_ESP32S3_TRACEERR_BADCLEARFEATURE    0x02
#define BOSS1_ESP32S3_TRACEERR_BADDEVGETSTATUS    0x03
#define BOSS1_ESP32S3_TRACEERR_BADEPNO            0x04
#define BOSS1_ESP32S3_TRACEERR_BADEPGETSTATUS     0x05
#define BOSS1_ESP32S3_TRACEERR_BADGETCONFIG       0x06
#define BOSS1_ESP32S3_TRACEERR_BADGETSETDESC      0x07
#define BOSS1_ESP32S3_TRACEERR_BADGETSTATUS       0x08
#define BOSS1_ESP32S3_TRACEERR_BADSETADDRESS      0x09
#define BOSS1_ESP32S3_TRACEERR_BADSETCONFIG       0x0a
#define BOSS1_ESP32S3_TRACEERR_BADSETFEATURE      0x0b
#define BOSS1_ESP32S3_TRACEERR_BADTESTMODE        0x0c
#define BOSS1_ESP32S3_TRACEERR_BINDFAILED         0x0d
#define BOSS1_ESP32S3_TRACEERR_DISPATCHSTALL      0x0e
#define BOSS1_ESP32S3_TRACEERR_DRIVER             0x0f
#define BOSS1_ESP32S3_TRACEERR_DRIVERREGISTERED   0x10
#define BOSS1_ESP32S3_TRACEERR_EP0NOSETUP         0x11
#define BOSS1_ESP32S3_TRACEERR_EP0SETUPSTALLED    0x12
#define BOSS1_ESP32S3_TRACEERR_EPINNULLPACKET     0x13
#define BOSS1_ESP32S3_TRACEERR_EPINUNEXPECTED     0x14
#define BOSS1_ESP32S3_TRACEERR_EPOUTNULLPACKET    0x15
#define BOSS1_ESP32S3_TRACEERR_EPOUTUNEXPECTED    0x16
#define BOSS1_ESP32S3_TRACEERR_INVALIDCTRLREQ     0x17
#define BOSS1_ESP32S3_TRACEERR_INVALIDPARMS       0x18
#define BOSS1_ESP32S3_TRACEERR_IRQREGISTRATION    0x19
#define BOSS1_ESP32S3_TRACEERR_NOEP               0x1a
#define BOSS1_ESP32S3_TRACEERR_NOTCONFIGURED      0x1b
#define BOSS1_ESP32S3_TRACEERR_EPOUTQEMPTY        0x1c
#define BOSS1_ESP32S3_TRACEERR_EPINREQEMPTY       0x1d
#define BOSS1_ESP32S3_TRACEERR_NOOUTSETUP         0x1e
#define BOSS1_ESP32S3_TRACEERR_POLLTIMEOUT        0x1f

/* Trace interrupt codes */

#define BOSS1_ESP32S3_TRACEINTID_USB              1 /* USB Interrupt entry/exit */
#define BOSS1_ESP32S3_TRACEINTID_INTPENDING       2 /* On each pass through the loop */

#define BOSS1_ESP32S3_TRACEINTID_EPOUT            (10 + 0)  /* First level interrupt decode */
#define BOSS1_ESP32S3_TRACEINTID_EPIN             (10 + 1)
#define BOSS1_ESP32S3_TRACEINTID_MISMATCH         (10 + 2)
#define BOSS1_ESP32S3_TRACEINTID_WAKEUP           (10 + 3)
#define BOSS1_ESP32S3_TRACEINTID_SUSPEND          (10 + 4)
#define BOSS1_ESP32S3_TRACEINTID_SOF              (10 + 5)
#define BOSS1_ESP32S3_TRACEINTID_RXFIFO           (10 + 6)
#define BOSS1_ESP32S3_TRACEINTID_DEVRESET         (10 + 7)
#define BOSS1_ESP32S3_TRACEINTID_ENUMDNE          (10 + 8)
#define BOSS1_ESP32S3_TRACEINTID_IISOIXFR         (10 + 9)
#define BOSS1_ESP32S3_TRACEINTID_IISOOXFR         (10 + 10)
#define BOSS1_ESP32S3_TRACEINTID_SRQ              (10 + 11)
#define BOSS1_ESP32S3_TRACEINTID_OTG              (10 + 12)

#define BOSS1_ESP32S3_TRACEINTID_EPOUT_XFRC       (40 + 0)  /* EPOUT second level decode */
#define BOSS1_ESP32S3_TRACEINTID_EPOUT_EPDISD     (40 + 1)
#define BOSS1_ESP32S3_TRACEINTID_EPOUT_SETUP      (40 + 2)
#define BOSS1_ESP32S3_TRACEINTID_DISPATCH         (40 + 3)

#define BOSS1_ESP32S3_TRACEINTID_GETSTATUS        (50 + 0)  /* EPOUT third level decode */
#define BOSS1_ESP32S3_TRACEINTID_EPGETSTATUS      (50 + 1)
#define BOSS1_ESP32S3_TRACEINTID_DEVGETSTATUS     (50 + 2)
#define BOSS1_ESP32S3_TRACEINTID_IFGETSTATUS      (50 + 3)
#define BOSS1_ESP32S3_TRACEINTID_CLEARFEATURE     (50 + 4)
#define BOSS1_ESP32S3_TRACEINTID_SETFEATURE       (50 + 5)
#define BOSS1_ESP32S3_TRACEINTID_SETADDRESS       (50 + 6)
#define BOSS1_ESP32S3_TRACEINTID_GETSETDESC       (50 + 7)
#define BOSS1_ESP32S3_TRACEINTID_GETCONFIG        (50 + 8)
#define BOSS1_ESP32S3_TRACEINTID_SETCONFIG        (50 + 9)
#define BOSS1_ESP32S3_TRACEINTID_GETSETIF         (50 + 10)
#define BOSS1_ESP32S3_TRACEINTID_SYNCHFRAME       (50 + 11)

#define BOSS1_ESP32S3_TRACEINTID_EPIN_XFRC        (70 + 0)  /* EPIN second level decode */
#define BOSS1_ESP32S3_TRACEINTID_EPIN_TOC         (70 + 1)
#define BOSS1_ESP32S3_TRACEINTID_EPIN_ITTXFE      (70 + 2)
#define BOSS1_ESP32S3_TRACEINTID_EPIN_EPDISD      (70 + 3)
#define BOSS1_ESP32S3_TRACEINTID_EPIN_TXFE        (70 + 4)

#define BOSS1_ESP32S3_TRACEINTID_EPIN_EMPWAIT     (80 + 0)  /* EPIN second level decode */

#define BOSS1_ESP32S3_TRACEINTID_OUTNAK           (90 + 0)  /* RXFLVL second level decode */
#define BOSS1_ESP32S3_TRACEINTID_OUTRECVD         (90 + 1)
#define BOSS1_ESP32S3_TRACEINTID_OUTDONE          (90 + 2)
#define BOSS1_ESP32S3_TRACEINTID_SETUPDONE        (90 + 3)
#define BOSS1_ESP32S3_TRACEINTID_SETUPRECVD       (90 + 4)

/* Endpoints ****************************************************************/

/* Odd physical endpoint numbers are IN; even are OUT */

#define BOSS1_ESP32S3_EPPHYIN2LOG(epphy)    ((uint8_t)(epphy) | USB_DIR_IN)
#define BOSS1_ESP32S3_EPPHYOUT2LOG(epphy)   ((uint8_t)(epphy) | USB_DIR_OUT)
...
#define BOSS1_ESP32S3_EP_AVAILABLE          (0xfe)   /* All available endpoints */

/* Delays *******************************************************************/

#define BOSS1_ESP32S3_READY_DELAY           200000
#define BOSS1_ESP32S3_FLUSH_DELAY           200000
...
struct esp32s3_usbdev_s
{
  ...
  uint8_t ep0data[BOSS1_ESP32S3_CDCACM_EP0MAXPACKET];
  uint16_t ep0datlen;

  /* The endpoint lists */

  struct esp32s3_ep_s epin[BOSS1_ESP32S3_ENDPOINT_NUM];
  struct esp32s3_ep_s epout[BOSS1_ESP32S3_ENDPOINT_NUM];
};
...
#ifdef CONFIG_BOSS1_ESP32S3_OTG_DEBUG_REGISTER
...
{
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_ALLOCFAIL),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BADCLEARFEATURE),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BADDEVGETSTATUS),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BADEPNO),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BADEPGETSTATUS),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BADGETCONFIG),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BADGETSETDESC),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BADGETSTATUS),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BADSETADDRESS),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BADSETCONFIG),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BADSETFEATURE),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BADTESTMODE),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_BINDFAILED),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_DISPATCHSTALL),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_DRIVER),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_DRIVERREGISTERED),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_EP0NOSETUP),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_EP0SETUPSTALLED),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_EPINNULLPACKET),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_EPINUNEXPECTED),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_EPOUTNULLPACKET),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_EPOUTUNEXPECTED),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_INVALIDCTRLREQ),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_INVALIDPARMS),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_IRQREGISTRATION),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_NOEP),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_NOTCONFIGURED),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_EPOUTQEMPTY),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_EPINREQEMPTY),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_NOOUTSETUP),
  TRACE_STR(BOSS1_ESP32S3_TRACEERR_POLLTIMEOUT),
  TRACE_STR_END
};
#endif
...
{
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_USB),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_INTPENDING),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPOUT),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPIN),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_MISMATCH),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_WAKEUP),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_SUSPEND),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_SOF),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_RXFIFO),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_DEVRESET),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_ENUMDNE),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_IISOIXFR),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_IISOOXFR),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_SRQ),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_OTG),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPOUT_XFRC),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPOUT_EPDISD),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPOUT_SETUP),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_DISPATCH),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_GETSTATUS),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPGETSTATUS),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_DEVGETSTATUS),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_IFGETSTATUS),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_CLEARFEATURE),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_SETFEATURE),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_SETADDRESS),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_GETSETDESC),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_GETCONFIG),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_SETCONFIG),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_GETSETIF),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_SYNCHFRAME),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPIN_XFRC),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPIN_TOC),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPIN_ITTXFE),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPIN_EPDISD),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPIN_TXFE),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_EPIN_EMPWAIT),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_OUTNAK),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_OUTRECVD),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_OUTDONE),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_SETUPDONE),
  TRACE_STR(BOSS1_ESP32S3_TRACEINTID_SETUPRECVD),
  TRACE_STR_END
};
#endif
...
static void esp32s3_ep0in_activate(void)
{
  ...
  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DIEPCTL(0));
  regval &= ~OTG_DIEPCTL0_MPSIZ_MASK;

#if BOSS1_ESP32S3_CDCACM_EP0MAXPACKET == 8
  regval |= OTG_DIEPCTL0_MPSIZ_8;
#elif BOSS1_ESP32S3_CDCACM_EP0MAXPACKET == 16
  regval |= OTG_DIEPCTL0_MPSIZ_16;
#elif BOSS1_ESP32S3_CDCACM_EP0MAXPACKET == 32
  regval |= OTG_DIEPCTL0_MPSIZ_32;
#elif BOSS1_ESP32S3_CDCACM_EP0MAXPACKET == 64
  regval |= OTG_DIEPCTL0_MPSIZ_64;
#else
#  error "Unsupported value of BOSS1_ESP32S3_CDCACM_EP0MAXPACKET"
#endif

  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DIEPCTL(0));

  /* Clear global IN NAK */

  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DCTL);
  regval |= OTG_DCTL_CGINAK;
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DCTL);
}
...
static void esp32s3_ep0out_ctrlsetup(struct esp32s3_usbdev_s *priv)
{
  ...
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DOEPTSIZ(0));

  /* Then clear NAKing and enable the transfer */

  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DOEPCTL(0));
  regval |= (OTG_DOEPCTL0_CNAK | OTG_DOEPCTL0_EPENA);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DOEPCTL(0));
}
                                 ...
                                 int nbytes)
{
  ...
  regaddr = BOSS1_ESP32S3_OTG_DFIFO_DEP(privep->epphy);
                                  ...
                                  int nbytes)
{
  ...
  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DIEPTSIZ(privep->epphy));
  ...
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DIEPTSIZ(privep->epphy));

  /* Read the DIEPCTLx register */

  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DIEPCTL(privep->epphy));
  ...
  if (privep->eptype == USB_EP_ATTR_XFER_ISOC)
    {
      ...
      uint32_t status = esp32s3_getreg(BOSS1_ESP32S3_OTG_DSTS);
  ...
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DIEPCTL(privep->epphy));
                                 ...
                                 struct esp32s3_ep_s *privep)
{
  ...
  if (!privreq)
    {
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_EPINREQEMPTY), privep->epphy);
      ...
      regaddr = BOSS1_ESP32S3_OTG_DIEPCTL(privep->epphy);
  ...
  if (privreq->req.xfrd < privreq->req.len || privep->zlp)
#endif
    {
      ...
      regaddr = BOSS1_ESP32S3_OTG_DTXFSTS(privep->epphy);
      ...
      if ((int)(regval & OTG_DTXFSTS_MASK) < nwords)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPIN_EMPWAIT),
                   (uint16_t)regval);
          ...
          uint32_t empmsk = esp32s3_getreg(BOSS1_ESP32S3_OTG_DIEPEMPMSK);
          empmsk |= OTG_DIEPEMPMSK(privep->epphy);
          esp32s3_putreg(empmsk, BOSS1_ESP32S3_OTG_DIEPEMPMSK);
          ...
          regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DIEPTXF(privep->epphy));
                                ...
                                uint16_t len)
{
  ...
  regaddr = BOSS1_ESP32S3_OTG_DFIFO_DEP(EP0);
  ...
  if (!privreq)
    {
      ...
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_EPOUTQEMPTY), privep->epphy);
      privep->active = false;
      return;
    }
  ...
  if (priv->ep0state == EP0STATE_SETUP_OUT)
    {
      ...
      int readlen = MIN(BOSS1_ESP32S3_CDCACM_EP0MAXPACKET, bcnt);
  ...
  else
    {
      ...
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_NOOUTSETUP), priv->ep0state);
  ...
  if (!privreq)
    {
      ...
      if (privep->epphy == 0)
      ...
      else
        {
          ...
          usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_EPOUTQEMPTY),
                   privep->epphy);
  ...
  if (!privep->active)
    {
      ...
      for (; ; )
        {
          ...
          if (!privreq)
            {
              ...
              regaddr = BOSS1_ESP32S3_OTG_DOEPCTL(privep->epphy);
              regval = esp32s3_getreg(regaddr);
          ...
          if (privreq->req.len <= 0)
            {
              usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_EPOUTNULLPACKET), 0);
              esp32s3_req_complete(privep, OK);
            }
      ...
      regaddr = BOSS1_ESP32S3_OTG_DOEPTSIZ(privep->epphy);
      regval = esp32s3_getreg(regaddr);
                              ...
                              uint16_t eplog)
{
  ...
  if (epphy >= BOSS1_ESP32S3_ENDPOINT_NUM)
    {
      return NULL;
    }
                                ...
                                const struct usb_ctrlreq_s *ctrl)
{
  ...
  usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_DISPATCH), 0);
  if (priv->driver)
    {
  ...
  if (ret < 0)
    {
      ...
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_DISPATCHSTALL), 0);
      priv->stalled = true;
    }
...
static void esp32s3_usbreset(struct esp32s3_usbdev_s *priv)
{
  ...
  priv->epavail[0] = BOSS1_ESP32S3_EP_AVAILABLE;
  priv->epavail[1] = BOSS1_ESP32S3_EP_AVAILABLE;

  /* Disable all end point interrupts */

  for (i = 0; i < BOSS1_ESP32S3_ENDPOINT_NUM; i++)
    {
      /* Disable endpoint interrupts */

      esp32s3_putreg(0xff, BOSS1_ESP32S3_OTG_DIEPINT(i));
      esp32s3_putreg(0xff, BOSS1_ESP32S3_OTG_DOEPINT(i));
                                    ...
                                    uint16_t index)
{
  ...
  switch (testmode)
    ...
    default:
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_BADTESTMODE), testmode);
      priv->dotest = false;
                                      ...
                                      struct esp32s3_ctrlreq_s *ctrlreq)
{
  ...
  switch (ctrlreq->req)
    ...
    case USB_REQ_GETSTATUS:
      {
        ...
        usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_GETSTATUS), 0);
        if (!priv->addressed ||
            ctrlreq->len != 2 ||
        ...
        else
          {
            switch (ctrlreq->type & USB_REQ_RECIPIENT_MASK)
              ...
              case USB_REQ_RECIPIENT_ENDPOINT:
                {
                  usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPGETSTATUS),
                           0);
                  privep = esp32s3_ep_findbyaddr(priv, ctrlreq->index);
                  if (!privep)
                    {
                      usbtrace(TRACE_DEVERROR(
                                  BOSS1_ESP32S3_TRACEERR_BADEPGETSTATUS),
                               0);
                      priv->stalled = true;
                    }
                  else
              ...
              case USB_REQ_RECIPIENT_DEVICE:
                {
                  if (ctrlreq->index == 0)
                    {
                      usbtrace(
                        TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_DEVGETSTATUS),
                        0);
                    ...
                    {
                      usbtrace(
                        TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_BADDEVGETSTATUS),
                        0);
                      priv->stalled = true;
                    }
                }
              ...
              case USB_REQ_RECIPIENT_INTERFACE:
                {
                  usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_IFGETSTATUS),
                           0);
                  priv->ep0data[0] = 0;
                  priv->ep0data[1] = 0;
              ...
              default:
                {
                  usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_BADGETSTATUS), 0);
                  priv->stalled = true;
                }
                break;
              }
    ...
    case USB_REQ_CLEARFEATURE:
      {
        ...
        usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_CLEARFEATURE), 0);
        if (priv->addressed != 0 && ctrlreq->len == 0)
          ...
          {
            usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_BADCLEARFEATURE), 0);
            priv->stalled = true;
          }
      }
      break;
    ...
    case USB_REQ_SETFEATURE:
      {
        ...
        usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_SETFEATURE), 0);
        if (priv->addressed != 0 && ctrlreq->len == 0)
          {
            uint8_t recipient = ctrlreq->type & USB_REQ_RECIPIENT_MASK;
            if (recipient == USB_REQ_RECIPIENT_ENDPOINT &&
              ...
              {
                usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_BADSETFEATURE), 0);
                priv->stalled = true;
              }
          }
        else
    ...
    case USB_REQ_SETADDRESS:
      {
        ...
        usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_SETADDRESS),
                 ctrlreq->value);
        if ((ctrlreq->type & USB_REQ_RECIPIENT_MASK) ==
          ...
          {
            usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_BADSETADDRESS), 0);
            priv->stalled = true;
          }
      }
      break;
    ...
    case USB_REQ_SETDESCRIPTOR:
      ...
      {
        usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_GETSETDESC), 0);
        if (((ctrlreq->type & USB_REQ_RECIPIENT_MASK) ==
             USB_REQ_RECIPIENT_DEVICE) ||
          ...
          {
            usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_BADGETSETDESC), 0);
            priv->stalled = true;
          }
      }
      break;
    ...
    case USB_REQ_GETCONFIGURATION:
      ...
      {
        usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_GETCONFIG), 0);
        if (priv->addressed &&
            (ctrlreq->type & USB_REQ_RECIPIENT_MASK) ==
            USB_REQ_RECIPIENT_DEVICE
          ...
          {
            usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_BADGETCONFIG), 0);
            priv->stalled = true;
          }
      }
      break;
    ...
    case USB_REQ_SETCONFIGURATION:
      ...
      {
        usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_SETCONFIG), 0);
        if (priv->addressed &&
            (ctrlreq->type & USB_REQ_RECIPIENT_MASK) ==
            USB_REQ_RECIPIENT_DEVICE
            && ctrlreq->index == 0 && ctrlreq->len == 0)
          ...
          {
            usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_BADSETCONFIG), 0);
            priv->stalled = true;
          }
      }
      break;
    ...
    case USB_REQ_SETINTERFACE:
      ...
      {
        usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_GETSETIF), 0);
        esp32s3_req_dispatch(priv, &priv->ctrlreq);
      }
      break;
    ...
    case USB_REQ_SYNCHFRAME:
      ...
      {
        usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_SYNCHFRAME), 0);
      }
      break;

    default:
      {
        usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_INVALIDCTRLREQ), 0);
        priv->stalled = true;
      }
      break;
    }
...
static void esp32s3_ep0out_setup(struct esp32s3_usbdev_s *priv)
{
  ...
  if (priv->ep0state != EP0STATE_SETUP_READY)
    {
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_EP0NOSETUP), priv->ep0state);
      return;
    }
  ...
  if (priv->stalled)
    {
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_EP0SETUPSTALLED),
               priv->ep0state);
...
static inline void esp32s3_epout_interrupt(struct esp32s3_usbdev_s *priv)
{
  ...
  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DAINT);
  regval &= esp32s3_getreg(BOSS1_ESP32S3_OTG_DAINTMSK);
  ...
  if (daint == 0)
    {
      ...
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_EPOUTUNEXPECTED),
               (uint16_t)regval);
      ...
      while (daint)
        {
          if ((daint & 1) != 0)
            {
              regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DOEPINT(epno));
              uerr("DOEPINT(%d) = %08" PRIx32 "\n", epno, regval);
              esp32s3_putreg(0xff, BOSS1_ESP32S3_OTG_DOEPINT(epno));
            }
      ...
      if ((daint & 1) != 0)
        {
          ...
          doepint = esp32s3_getreg(BOSS1_ESP32S3_OTG_DOEPINT(epno));
          doepint &= esp32s3_getreg(BOSS1_ESP32S3_OTG_DOEPMSK);
          ...
          if ((doepint & OTG_DOEPINT_XFRC) != 0)
            {
              usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPOUT_XFRC),
                       (uint16_t)doepint);

              /* Clear the bit in DOEPINTn for this interrupt */

              esp32s3_putreg(OTG_DOEPINT_XFRC, BOSS1_ESP32S3_OTG_DOEPINT(epno));
          ...
          if ((doepint & OTG_DOEPINT_EPDISD) != 0)
            {
              usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPOUT_EPDISD),
                       (uint16_t)doepint);

              /* Clear the bit in DOEPINTn for this interrupt */

              esp32s3_putreg(OTG_DOEPINT_EPDISD, BOSS1_ESP32S3_OTG_DOEPINT(epno));
            }
#endif
          ...
          if ((doepint & OTG_DOEPINT_SETUP) != 0)
            {
              usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPOUT_SETUP),
                       priv->ep0state);
              ...
              esp32s3_putreg(OTG_DOEPINT_SETUP, BOSS1_ESP32S3_OTG_DOEPINT(epno));
            }
        }
...
static inline void esp32s3_epin_runtestmode(struct esp32s3_usbdev_s *priv)
{
  uint32_t regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DCTL);
...
static inline void esp32s3_epin_interrupt(struct esp32s3_usbdev_s *priv)
{
  ...
  daint = esp32s3_getreg(BOSS1_ESP32S3_OTG_DAINT);
  daint &= esp32s3_getreg(BOSS1_ESP32S3_OTG_DAINTMSK);
  ...
  if (daint == 0)
    {
      ...
      daint = esp32s3_getreg(BOSS1_ESP32S3_OTG_DAINT);
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_EPINUNEXPECTED),
               (uint16_t)daint);
          ...
          if ((daint & 1) != 0)
            {
              uerr("DIEPINT(%d) = %08" PRIx32 "\n",
                   epno, esp32s3_getreg(BOSS1_ESP32S3_OTG_DIEPINT(epno)));
              esp32s3_putreg(0xff, BOSS1_ESP32S3_OTG_DIEPINT(epno));
            }
      ...
      if ((daint & 1) != 0)
        {
          ...
          mask = esp32s3_getreg(BOSS1_ESP32S3_OTG_DIEPMSK);
          ...
          empty = esp32s3_getreg(BOSS1_ESP32S3_OTG_DIEPEMPMSK);
          ...
          diepint = esp32s3_getreg(BOSS1_ESP32S3_OTG_DIEPINT(epno)) & mask;
          ...
          if ((diepint & OTG_DIEPINT_XFRC) != 0)
            {
              usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPIN_XFRC),
                       (uint16_t)diepint);
              ...
              esp32s3_putreg(empty, BOSS1_ESP32S3_OTG_DIEPEMPMSK);
              esp32s3_putreg(OTG_DIEPINT_XFRC, BOSS1_ESP32S3_OTG_DIEPINT(epno));
          ...
          if ((diepint & OTG_DIEPINT_TOC) != 0)
            {
              usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPIN_TOC),
                       (uint16_t)diepint);
              esp32s3_putreg(OTG_DIEPINT_TOC, BOSS1_ESP32S3_OTG_DIEPINT(epno));
            }
          ...
          if ((diepint & OTG_DIEPINT_ITTXFE) != 0)
            {
              usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPIN_ITTXFE),
                       (uint16_t)diepint);
              esp32s3_epin_request(priv, &priv->epin[epno]);
              esp32s3_putreg(OTG_DIEPINT_ITTXFE, BOSS1_ESP32S3_OTG_DIEPINT(epno));
            }
          ...
          if ((diepint & OTG_DIEPINT_INEPNE) != 0)
            {
              usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPIN_INEPNE),
                       (uint16_t)diepint);
              esp32s3_putreg(OTG_DIEPINT_INEPNE, BOSS1_ESP32S3_OTG_DIEPINT(epno));
            }
#endif
          ...
          if ((diepint & OTG_DIEPINT_EPDISD) != 0)
            {
              usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPIN_EPDISD),
                       (uint16_t)diepint);
              esp32s3_putreg(OTG_DIEPINT_EPDISD, BOSS1_ESP32S3_OTG_DIEPINT(epno));
            }
#endif
          ...
          if ((diepint & OTG_DIEPINT_TXFE) != 0)
            {
              usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPIN_TXFE),
                       (uint16_t)diepint);
              ...
              esp32s3_putreg(OTG_DIEPINT_TXFE, BOSS1_ESP32S3_OTG_DIEPINT(epno));
            }
        }
...
static inline void esp32s3_resumeinterrupt(struct esp32s3_usbdev_s *priv)
{
  ...
  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_PCGCCTL);
  regval &= ~(OTG_PCGCCTL_STPPCLK | OTG_PCGCCTL_GATEHCLK);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_PCGCCTL);
#endif
...
static inline void esp32s3_suspendinterrupt(struct esp32s3_usbdev_s *priv)
{
  ...
  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DSTS);
...
static inline void esp32s3_rxinterrupt(struct esp32s3_usbdev_s *priv)
{
  ...
  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_GRXSTSP);
  ...
  if (epphy < BOSS1_ESP32S3_ENDPOINT_NUM)
    {
      ...
      switch (regval & OTG_GRXSTSD_PKTSTS_MASK)
        ...
        case OTG_GRXSTSD_PKTSTS_OUTNAK:
          {
            usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_OUTNAK), 0);
          }
          break;
        ...
        case OTG_GRXSTSD_PKTSTS_OUTRECVD:
          {
            usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_OUTRECVD), epphy);
        ...
        case OTG_GRXSTSD_PKTSTS_OUTDONE:
          {
            usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_OUTDONE), epphy);
          }
          break;
        ...
        case OTG_GRXSTSD_PKTSTS_SETUPDONE:
          {
            usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_SETUPDONE), epphy);
        ...
        case OTG_GRXSTSD_PKTSTS_SETUPRECVD:
          {
            ...
            usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_SETUPRECVD), epphy);
        ...
        default:
          {
            usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_INVALIDPARMS),
...
static inline void esp32s3_enuminterrupt(struct esp32s3_usbdev_s *priv)
{
  ...
  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_GUSBCFG);
  regval &= ~OTG_GUSBCFG_TRDT_MASK;
  regval |= OTG_GUSBCFG_TRDT(6);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_GUSBCFG);
}
  ...
  for (i = 0; i < BOSS1_ESP32S3_ENDPOINT_NUM; i++)
    {
      ...
      dsts = esp32s3_getreg(BOSS1_ESP32S3_OTG_DSTS);
...
static inline void esp32s3_otginterrupt(struct esp32s3_usbdev_s *priv)
{
  ...
  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_GOTGINT);
...
#  warning "Missing logic"
  ...
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_GOTGINT);
}
#endif
...
static int esp32s3_usbinterrupt(int irq, void *context, void *arg)
{
  ...
  usbtrace(TRACE_INTENTRY(BOSS1_ESP32S3_TRACEINTID_USB), 0);

  /* Assure that we are in device mode */

  DEBUGASSERT((esp32s3_getreg(BOSS1_ESP32S3_OTG_GINTSTS) & OTG_GINTSTS_CMOD) ==
              OTG_GINTSTS_DEVMODE);
  ...
  for (; ; )
    {
      ...
      regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_GINTSTS);
      reserved = (regval & OTG_GINT_RESERVED);
      regval &= esp32s3_getreg(BOSS1_ESP32S3_OTG_GINTMSK);
      ...
      usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_INTPENDING),
               (uint16_t)regval);
      ...
      if ((regval & OTG_GINT_OEP) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPOUT),
                   (uint16_t)regval);
      ...
      if ((regval & OTG_GINT_IEP) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_EPIN),
                   (uint16_t)regval);
      ...
      if ((regval & OTG_GINT_MMIS) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_MISMATCH),
                   (uint16_t)regval);
        }
#endif
      ...
      if ((regval & OTG_GINT_WKUP) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_WAKEUP),
                   (uint16_t)regval);
      ...
      if ((regval & OTG_GINT_USBSUSP) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_SUSPEND),
                   (uint16_t)regval);
      ...
      if ((regval & OTG_GINT_SOF) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_SOF),
                   (uint16_t)regval);
      ...
      if ((regval & OTG_GINT_RXFLVL) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_RXFIFO),
                   (uint16_t)regval);
      ...
      if ((regval & (OTG_GINT_USBRST | OTG_GINT_RSTDET)) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_DEVRESET),
                   (uint16_t)regval);

          /* Perform the device reset */

          esp32s3_usbreset(priv);
          usbtrace(TRACE_INTEXIT(BOSS1_ESP32S3_TRACEINTID_USB), 0);
          return OK;
        }
      ...
      if ((regval & OTG_GINT_ENUMDNE) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_ENUMDNE),
                   (uint16_t)regval);
      ...
      if ((regval & OTG_GINT_IISOIXFR) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_IISOIXFR),
                   (uint16_t)regval);
      ...
      if ((regval & OTG_GINT_IISOOXFR) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_IISOOXFR),
                   (uint16_t)regval);
      ...
      if ((regval & OTG_GINT_SRQ) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_SRQ),
                   (uint16_t)regval);
      ...
      if ((regval & OTG_GINT_OTG) != 0)
        {
          usbtrace(TRACE_INTDECODE(BOSS1_ESP32S3_TRACEINTID_OTG),
                   (uint16_t)regval);
...
static void esp32s3_enablegonak(struct esp32s3_ep_s *privep)
{
...
#if 0
  esp32s3_putreg(OTG_GINT_GONAKEFF, BOSS1_ESP32S3_OTG_GINTSTS);
#endif
  ...
  while ((esp32s3_getreg(BOSS1_ESP32S3_OTG_GINTSTS) & OTG_GINT_GONAKEFF) == 0);
  esp32s3_putreg(OTG_GINT_GONAKEFF, BOSS1_ESP32S3_OTG_GINTSTS);
  ...
  while ((esp32s3_getreg(BOSS1_ESP32S3_OTG_DCTL) & OTG_DCTL_GONSTS) == 0);
#endif
}
...
static void esp32s3_ep0_configure(struct esp32s3_usbdev_s *priv)
{
  ...
  esp32s3_epin_configure(&priv->epin[EP0], USB_EP_ATTR_XFER_CONTROL,
                         BOSS1_ESP32S3_CDCACM_EP0MAXPACKET);
...
static void esp32s3_epout_disable(struct esp32s3_ep_s *privep)
{
...
#if 0    /* Doesn't happen */
  regaddr = BOSS1_ESP32S3_OTG_DOEPINT(privep->epphy);
  ...
  esp32s3_putreg(OTG_DOEPINT_EPDISD, BOSS1_ESP32S3_OTG_DOEPINT(privep->epphy));
...
static void esp32s3_epin_disable(struct esp32s3_ep_s *privep)
{
  ...
  esp32s3_putreg(OTG_DIEPINT_INEPNE, BOSS1_ESP32S3_OTG_DIEPINT(privep->epphy));
  ...
  regaddr = BOSS1_ESP32S3_OTG_DIEPINT(privep->epphy);
...
static int esp32s3_ep_disable(struct usbdev_ep_s *ep)
{
  ...
  if (!ep)
    {
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_INVALIDPARMS), 0);
      return -EINVAL;
    }
#endif
...
static struct usbdev_req_s *esp32s3_ep_allocreq(struct usbdev_ep_s *ep)
{
  ...
  if (!privreq)
    {
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_ALLOCFAIL), 0);
      return NULL;
    }
                             ...
                             struct usbdev_req_s *req)
{
  ...
  if (!priv->driver)
    {
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_NOTCONFIGURED),
               priv->usbdev.speed);
      return -ESHUTDOWN;
    }
#endif
                                            ...
                                            uint8_t eptype)
{
  ...
  if (epphy > 0)
    {
      ...
      if (epphy >= BOSS1_ESP32S3_ENDPOINT_NUM)
        {
          usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_BADEPNO),
                   (uint16_t)epphy);
          return NULL;
        }
  ...
  if (epavail)
    {
      ...
      for (epno = 1; epno < BOSS1_ESP32S3_ENDPOINT_NUM; epno++)
        {
          uint8_t bit = 1 << epno;
          if ((epavail & bit) != 0)
            {
  ...
  usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_NOEP), (uint16_t)eplog);
  leave_critical_section(flags);
  return NULL;
}
                               ...
                               uint16_t address)
{
  ...
  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DCFG);
  regval &= ~OTG_DCFG_DAD_MASK;
  regval |= ((uint32_t)address << OTG_DCFG_DAD_SHIFT);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DCFG);
...
static int esp32s3_txfifo_flush(uint32_t txfnum)
{
  ...
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_GRSTCTL);

  /* Wait for the FLUSH to complete */

  for (timeout = 0; timeout < BOSS1_ESP32S3_FLUSH_DELAY; timeout++)
    {
      regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_GRSTCTL);
...
static int esp32s3_rxfifo_flush(void)
{
  ...
  esp32s3_putreg(OTG_GRSTCTL_RXFFLSH, BOSS1_ESP32S3_OTG_GRSTCTL);
  ...
  for (i = 0; i < BOSS1_ESP32S3_ENDPOINT_NUM; i++)
    {
      ...
      privep->epphy = i;
      privep->ep.eplog = BOSS1_ESP32S3_EPPHYIN2LOG(i);

      /* Control until endpoint is activated */

      privep->eptype = USB_EP_ATTR_XFER_CONTROL;
      privep->ep.maxpacket = BOSS1_ESP32S3_CDCACM_EP0MAXPACKET;
    }
  ...
  for (i = 0; i < BOSS1_ESP32S3_ENDPOINT_NUM; i++)
    {
      ...
      privep->epphy = i;
      privep->ep.eplog = BOSS1_ESP32S3_EPPHYOUT2LOG(i);
...
static void esp32s3_hwinitialize(struct esp32s3_usbdev_s *priv)
{
  ...
  esp32s3_putreg(OTG_GAHBCFG_TXFELVL, BOSS1_ESP32S3_OTG_GAHBCFG);
  ...
  for (timeout = 0; timeout < BOSS1_ESP32S3_READY_DELAY; timeout++)
    {
      up_udelay(3);
      regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_GRSTCTL);
  ...
  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_GCCFG);
  ...
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_GCCFG);
  up_mdelay(20);

  /* When VBUS sensing is not used we need to force the B session valid */

#ifndef CONFIG_USBDEV_VBUSSENSING
  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_GOTGCTL);
  regval |= (OTG_GOTGCTL_BVALOEN | OTG_GOTGCTL_BVALOVAL);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_GOTGCTL);
#endif
  ...
  esp32s3_putreg(0, BOSS1_ESP32S3_OTG_PCGCCTL);
  ...
  esp32s3_putreg(BOSS1_ESP32S3_RXFIFO_WORDS, BOSS1_ESP32S3_OTG_GRXFSIZ);

#if BOSS1_ESP32S3_ENDPOINT_NUM > 0
  address = BOSS1_ESP32S3_RXFIFO_WORDS;
  regval = (address << OTG_DIEPTXF0_TX0FD_SHIFT) |
    (BOSS1_ESP32S3_EP0_TXFIFO_WORDS << OTG_DIEPTXF0_TX0FSA_SHIFT);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DIEPTXF0);
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 1
  address += BOSS1_ESP32S3_EP0_TXFIFO_WORDS;
  regval = (address << OTG_DIEPTXF_INEPTXSA_SHIFT) |
    (BOSS1_ESP32S3_EP1_TXFIFO_WORDS << OTG_DIEPTXF_INEPTXFD_SHIFT);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DIEPTXF(1));
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 2
  address += BOSS1_ESP32S3_EP1_TXFIFO_WORDS;
  regval = (address << OTG_DIEPTXF_INEPTXSA_SHIFT) |
    (BOSS1_ESP32S3_EP2_TXFIFO_WORDS << OTG_DIEPTXF_INEPTXFD_SHIFT);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DIEPTXF(2));
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 3
  address += BOSS1_ESP32S3_EP2_TXFIFO_WORDS;
  regval = (address << OTG_DIEPTXF_INEPTXSA_SHIFT) |
    (BOSS1_ESP32S3_EP3_TXFIFO_WORDS << OTG_DIEPTXF_INEPTXFD_SHIFT);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DIEPTXF(3));
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 4
  address += BOSS1_ESP32S3_EP3_TXFIFO_WORDS;
  regval = (address << OTG_DIEPTXF_INEPTXSA_SHIFT) |
    (BOSS1_ESP32S3_EP4_TXFIFO_WORDS << OTG_DIEPTXF_INEPTXFD_SHIFT);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DIEPTXF(4));
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 5
  address += BOSS1_ESP32S3_EP4_TXFIFO_WORDS;
  regval = (address << OTG_DIEPTXF_INEPTXSA_SHIFT) |
    (BOSS1_ESP32S3_EP5_TXFIFO_WORDS << OTG_DIEPTXF_INEPTXFD_SHIFT);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DIEPTXF(5));
#endif

#if BOSS1_ESP32S3_ENDPOINT_NUM > 6
  address += BOSS1_ESP32S3_EP5_TXFIFO_WORDS;
  regval = (address << OTG_DIEPTXF_INEPTXSA_SHIFT) |
    (BOSS1_ESP32S3_EP6_TXFIFO_WORDS << OTG_DIEPTXF_INEPTXFD_SHIFT);
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DIEPTXF(6));
#endif
  ...
  esp32s3_putreg(0, BOSS1_ESP32S3_OTG_DIEPMSK);
  esp32s3_putreg(0, BOSS1_ESP32S3_OTG_DOEPMSK);
  esp32s3_putreg(0, BOSS1_ESP32S3_OTG_DIEPEMPMSK);
  esp32s3_putreg(0xffffffff, BOSS1_ESP32S3_OTG_DAINT);
  esp32s3_putreg(0, BOSS1_ESP32S3_OTG_DAINTMSK);

  /* Configure all IN endpoints */

  for (i = 0; i < BOSS1_ESP32S3_ENDPOINT_NUM; i++)
    {
      regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DIEPCTL(i));
      ...
      esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DIEPCTL(i));
      esp32s3_putreg(0, BOSS1_ESP32S3_OTG_DIEPTSIZ(i));
      esp32s3_putreg(0xff, BOSS1_ESP32S3_OTG_DIEPINT(i));
    }
  ...
  for (i = 0; i < BOSS1_ESP32S3_ENDPOINT_NUM; i++)
    {
      regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_DOEPCTL(i));
      ...
      esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_DOEPCTL(i));
      esp32s3_putreg(0, BOSS1_ESP32S3_OTG_DOEPTSIZ(i));
      esp32s3_putreg(0xff, BOSS1_ESP32S3_OTG_DOEPINT(i));
    }

  /* Disable all interrupts. */

  esp32s3_putreg(0, BOSS1_ESP32S3_OTG_GINTMSK);

  /* Clear any pending USB_OTG Interrupts */

  esp32s3_putreg(0xffffffff, BOSS1_ESP32S3_OTG_GOTGINT);

  /* Clear any pending interrupts */

  regval = esp32s3_getreg(BOSS1_ESP32S3_OTG_GINTSTS);
  regval &= OTG_GINT_RESERVED;
  esp32s3_putreg(regval | OTG_GINT_RC_W1, BOSS1_ESP32S3_OTG_GINTSTS);
  ...
  esp32s3_putreg(regval, BOSS1_ESP32S3_OTG_GINTMSK);
...
void xtensa_usbinitialize(void)
{
  ...
  priv->cpu = this_cpu();
  priv->cpuint = esp32s3_setup_irq(priv->cpu, BOSS1_ESP32S3_PERIPH_USB,
                                   1, BOSS1_ESP32S3_CPUINT_LEVEL);
  DEBUGASSERT(priv->cpuint >= 0);

  ret = irq_attach(BOSS1_ESP32S3_IRQ_USB, esp32s3_usbinterrupt, NULL);
  DEBUGASSERT(ret == 0);
  ...
  up_enable_irq(BOSS1_ESP32S3_IRQ_USB);
}
...
void xtensa_usbuninitialize(void)
{
  ...
  if (priv->driver)
    {
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_DRIVERREGISTERED), 0);
  ...
  up_disable_irq(BOSS1_ESP32S3_IRQ_USB);
  irq_detach(BOSS1_ESP32S3_IRQ_USB);
...
int usbdev_register(struct usbdevclass_driver_s *driver)
{
  ...
  if (priv->driver)
    {
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_DRIVER), 0);
      return -EBUSY;
    }
#endif
  ...
  if (ret)
    {
      usbtrace(TRACE_DEVERROR(BOSS1_ESP32S3_TRACEERR_BINDFAILED), (uint16_t)-ret);
      priv->driver = NULL;
    }
  else
    {
