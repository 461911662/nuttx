...
#else  /* #if CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED_80M */
#  define PSRAM_SPEED PSRAM_CACHE_S80M
#endif

#if CONFIG_BOSS1_ESP32S3_SPIRAM_VADDR_OFFSET
#define SPIRAM_VADDR_OFFSET   CONFIG_BOSS1_ESP32S3_SPIRAM_VADDR_OFFSET
#else
#define SPIRAM_VADDR_OFFSET   0
#endif

#if CONFIG_BOSS1_ESP32S3_SPIRAM_VADDR_MAP_SIZE
#define SPIRAM_VADDR_MAP_SIZE CONFIG_BOSS1_ESP32S3_SPIRAM_VADDR_MAP_SIZE
#else
...
#if defined(CONFIG_BOSS1_ESP32S3_SPIRAM_FETCH_INSTRUCTIONS)
static int      g_instr_flash2spiram_offs;
static uint32_t g_instr_start_page;
static uint32_t g_instr_end_page;
#endif

#if defined(CONFIG_BOSS1_ESP32S3_SPIRAM_RODATA)
...
int IRAM_ATTR esp_spiram_init(void)
{
...
#if defined(CONFIG_BOSS1_ESP32S3_SPIRAM_SIZE) && (CONFIG_BOSS1_ESP32S3_SPIRAM_SIZE != -1)
  if (psram_physical_size != CONFIG_BOSS1_ESP32S3_SPIRAM_SIZE)
    {
      merr("Expected %dMB chip but found %dMB chip. Bailing out..",
           (CONFIG_BOSS1_ESP32S3_SPIRAM_SIZE / 1024 / 1024),
  ...
  minfo("Speed: %dMHz\n", CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED);
