...
#ifdef CONFIG_BOSS1_ESP32S3_SPI_FLASH_DONT_USE_ROM_CODE
...
#  ifdef CONFIG_BOSS1_ESP32S3_SPI_FLASH_USE_32BIT_ADDRESS
...
#endif /* CONFIG_BOSS1_ESP32S3_SPI_FLASH_DONT_USE_ROM_CODE */
...
static int spiflash_init_spi_flash_op_block_task(int cpu)
{
  ...
  pid = kthread_create("spiflash_op",
                       SCHED_PRIORITY_MAX,
                       CONFIG_BOSS1_ESP32S3_SPIFLASH_OP_TASK_STACKSIZE,
