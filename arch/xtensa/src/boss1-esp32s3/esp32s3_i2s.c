...
#  define CONFIG_BOSS1_ESP32S3_I2S_DUMPBUFFERS
#else
#  undef CONFIG_BOSS1_ESP32S3_I2S_DUMPBUFFERS
#endif
...
struct esp32s3_i2s_s
{
  ...
  struct esp32s3_buffer_s containers[CONFIG_BOSS1_ESP32S3_I2S_MAXINFLIGHT];
};
...
#ifdef CONFIG_BOSS1_ESP32S3_I2S_DUMPBUFFERS
...
#ifdef CONFIG_BOSS1_ESP32S3_I2S0
static const struct esp32s3_i2s_config_s esp32s3_i2s0_config =
{
  .port             = 0,
#ifdef CONFIG_BOSS1_ESP32S3_I2S0_ROLE_MASTER
  .role             = I2S_ROLE_MASTER,
#else
  .role             = I2S_ROLE_SLAVE,
#endif /* CONFIG_BOSS1_ESP32S3_I2S0_ROLE_MASTER */
  .data_width       = CONFIG_BOSS1_ESP32S3_I2S0_DATA_BIT_WIDTH,
  .rate             = CONFIG_BOSS1_ESP32S3_I2S0_SAMPLE_RATE,
  .total_slot       = 2,
  .tx_en            = I2S0_TX_ENABLED,
  .rx_en            = I2S0_RX_ENABLED,
  .tx_clk_src       = I2S_PLL_D2_CLK,
  .rx_clk_src       = I2S_PLL_D2_CLK,
#ifdef CONFIG_BOSS1_ESP32S3_I2S0_MCLK
  .mclk_pin         = CONFIG_BOSS1_ESP32S3_I2S0_MCLKPIN,
#else
  .mclk_pin         = I2S_GPIO_UNUSED,
#endif /* CONFIG_BOSS1_ESP32S3_I2S0_MCLK */
  .bclk_pin         = CONFIG_BOSS1_ESP32S3_I2S0_BCLKPIN,
  .ws_pin           = CONFIG_BOSS1_ESP32S3_I2S0_WSPIN,
#ifdef CONFIG_BOSS1_ESP32S3_I2S0_DOUTPIN
  .dout_pin         = CONFIG_BOSS1_ESP32S3_I2S0_DOUTPIN,
#else
  .dout_pin         = I2S_GPIO_UNUSED,
#endif /* CONFIG_BOSS1_ESP32S3_I2S0_DOUTPIN */
#ifdef CONFIG_BOSS1_ESP32S3_I2S0_DINPIN
  .din_pin          = CONFIG_BOSS1_ESP32S3_I2S0_DINPIN,
#else
  .din_pin          = I2S_GPIO_UNUSED,
#endif /* CONFIG_BOSS1_ESP32S3_I2S0_DINPIN */
...
#endif /* CONFIG_BOSS1_ESP32S3_I2S0 */

#ifdef CONFIG_BOSS1_ESP32S3_I2S1
static const struct esp32s3_i2s_config_s esp32s3_i2s1_config =
{
  .port             = 1,
#ifdef CONFIG_BOSS1_ESP32S3_I2S1_ROLE_MASTER
  .role             = I2S_ROLE_MASTER,
#else
  .role             = I2S_ROLE_SLAVE,
#endif /* CONFIG_BOSS1_ESP32S3_I2S1_ROLE_MASTER */
  .data_width       = CONFIG_BOSS1_ESP32S3_I2S1_DATA_BIT_WIDTH,
  .rate             = CONFIG_BOSS1_ESP32S3_I2S1_SAMPLE_RATE,
  .total_slot       = 2,
  .tx_en            = I2S1_TX_ENABLED,
  .rx_en            = I2S1_RX_ENABLED,
  .tx_clk_src       = I2S_PLL_D2_CLK,
  .tx_clk_src       = I2S_PLL_D2_CLK,
#ifdef CONFIG_BOSS1_ESP32S3_I2S1_MCLK
  .mclk_pin         = CONFIG_BOSS1_ESP32S3_I2S1_MCLKPIN,
#else
  .mclk_pin         = I2S_GPIO_UNUSED,
#endif /* CONFIG_BOSS1_ESP32S3_I2S1_MCLK */
  .bclk_pin         = CONFIG_BOSS1_ESP32S3_I2S1_BCLKPIN,
  .ws_pin           = CONFIG_BOSS1_ESP32S3_I2S1_WSPIN,
#ifdef CONFIG_BOSS1_ESP32S3_I2S1_DOUTPIN
  .dout_pin         = CONFIG_BOSS1_ESP32S3_I2S1_DOUTPIN,
#else
  .dout_pin         = I2S_GPIO_UNUSED,
#endif /* CONFIG_BOSS1_ESP32S3_I2S1_DOUTPIN */
#ifdef CONFIG_BOSS1_ESP32S3_I2S1_DINPIN
  .din_pin          = CONFIG_BOSS1_ESP32S3_I2S1_DINPIN,
#else
  .din_pin          = I2S_GPIO_UNUSED,
#endif /* CONFIG_BOSS1_ESP32S3_I2S1_DINPIN */
...
#endif /* CONFIG_BOSS1_ESP32S3_I2S1 */
...
static int i2s_buf_initialize(struct esp32s3_i2s_s *priv)
{
  ...
  for (int i = 0; i < CONFIG_BOSS1_ESP32S3_I2S_MAXINFLIGHT; i++)
    {
...
static int i2s_rxdma_start(struct esp32s3_i2s_s *priv)
{
  ...
  eof_nbytes = MIN(bfcontainer->nbytes, BOSS1_ESP32S3_DMA_BUFLEN_MAX);
  ...
  if (!sq_empty(&priv->tx.act))
    {
      ...
      while (!(bfdesc->ctrl & BOSS1_ESP32S3_DMA_CTRL_EOF))
        {
  ...
  if (!sq_empty(&priv->rx.act))
    {
      ...
      while (bfdesc->next != NULL &&
             (bfdesc->next->ctrl & BOSS1_ESP32S3_DMA_CTRL_EOF))
        {
          bfdesc = bfdesc->next;
        }
  ...
  while (sq_peek(&priv->rx.done) != NULL)
    {
      ...
      while (dmadesc != NULL && (dmadesc->ctrl & BOSS1_ESP32S3_DMA_CTRL_EOF))
        {
          bfcontainer->apb->nbytes +=
              (dmadesc->ctrl >> BOSS1_ESP32S3_DMA_CTRL_DATALEN_S) &
              BOSS1_ESP32S3_DMA_CTRL_DATALEN_V;
...
static void i2s_configure(struct esp32s3_i2s_s *priv)
{
  ...
  if (priv->config->port == BOSS1_ESP32S3_I2S0)
    {
  ...
  if (priv->config->tx_en)
    {
      ...
      if (nbytes > (BOSS1_ESP32S3_DMA_BUFLEN_MAX * I2S_DMADESC_NUM))
        {
          i2serr("Required buffer size can't fit into DMA outlink "
                 ...
                 nbytes - (BOSS1_ESP32S3_DMA_BUFLEN_MAX * I2S_DMADESC_NUM));
          return -EFBIG;
        }
  ...
  if (priv->config->rx_en)
    {
      ...
      nbytes = MIN(nbytes, BOSS1_ESP32S3_DMA_BUFLEN_MAX);
...
static int i2s_dma_setup(struct esp32s3_i2s_s *priv)
{
  ...
  if (priv->config->port == 0)
    {
      i2s_dma_dev = BOSS1_ESP32S3_DMA_PERIPH_I2S0;
    }
  else
    {
      i2s_dma_dev = BOSS1_ESP32S3_DMA_PERIPH_I2S1;
    }
  ...
  if (priv->config->tx_en)
    {
      int periph = BOSS1_ESP32S3_PERIPH_DMA_OUT_CH0 + priv->dma_channel;
      ...
      priv->tx_irq = BOSS1_ESP32S3_PERIPH2IRQ(periph);
  ...
  if (priv->config->rx_en)
    {
      int periph = BOSS1_ESP32S3_PERIPH_DMA_IN_CH0 + priv->dma_channel;
      int cpuint = esp32s3_setup_irq(priv->cpu, periph, 1,
                                     BOSS1_ESP32S3_CPUINT_LEVEL);
      if (cpuint < 0)
        {
      ...
      priv->rx_irq = BOSS1_ESP32S3_PERIPH2IRQ(periph);
...
struct i2s_dev_s *esp32s3_i2sbus_initialize(int port)
{
  ...
  switch (port)
    {
#ifdef CONFIG_BOSS1_ESP32S3_I2S0
      case BOSS1_ESP32S3_I2S0:
        priv = &esp32s3_i2s0_priv;
        break;
#endif
#ifdef CONFIG_BOSS1_ESP32S3_I2S1
      case BOSS1_ESP32S3_I2S1:
...
#endif /* CONFIG_BOSS1_ESP32S3_I2S */
