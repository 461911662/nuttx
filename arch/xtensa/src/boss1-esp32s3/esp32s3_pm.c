...
#ifdef CONFIG_BOSS1_ESP32S3_DEFAULT_CPU_FREQ_MHZ
#define DEFAULT_CPU_FREQ_MHZ CONFIG_BOSS1_ESP32S3_DEFAULT_CPU_FREQ_MHZ
#else
...
#define BOSS1_ESP32S3_NUARTS                      (3) /* UART0-2 */
...
static void IRAM_ATTR esp32s3_flush_uarts(void)
{
  ...
  for (i = 0; i < BOSS1_ESP32S3_NUARTS; ++i)
    {
