...
#if defined(CONFIG_BOSS1_ESP32S3_FLASH_SAMPLE_MODE_DTR) || \
    defined(CONFIG_BOSS1_ESP32S3_SPIRAM_MODE_OCT)
#  define BOSS1_ESP32S3_SPI_TIMING_CORE_CLOCK_DIV         2
#else
#  define BOSS1_ESP32S3_SPI_TIMING_CORE_CLOCK_DIV         1
#endif

#if defined(CONFIG_BOSS1_ESP32S3_FLASH_SAMPLE_MODE_DTR)
#  if defined(CONFIG_BOSS1_ESP32S3_FLASH_FREQ_80M)
#    define BOSS1_ESP32S3_SPI_TIMING_FLASH_CORE_CLK       160
#  elif defined(CONFIG_BOSS1_ESP32S3_FLASH_FREQ_120M)
#    define BOSS1_ESP32S3_SPI_TIMING_FLASH_CORE_CLK       240
#  endif
#elif defined(CONFIG_BOSS1_ESP32S3_FLASH_SAMPLE_MODE_STR)
#  if defined(CONFIG_BOSS1_ESP32S3_FLASH_FREQ_120M)
#    if BOSS1_ESP32S3_SPI_TIMING_CORE_CLOCK_DIV == 1
#      define BOSS1_ESP32S3_SPI_TIMING_FLASH_CORE_CLK     120
#    elif BOSS1_ESP32S3_SPI_TIMING_CORE_CLOCK_DIV == 2
#      define BOSS1_ESP32S3_SPI_TIMING_FLASH_CORE_CLK     240
#    endif
#  endif
#endif

#if defined(CONFIG_BOSS1_ESP32S3_SPIRAM_MODE_OCT)
#  if defined(CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED_80M)
#    define BOSS1_ESP32S3_SPI_TIMING_PSRAM_CORE_CLK       160
#  endif
#elif defined(BOSS1_ESP32S3_SPI_TIMING_PSRAM_STR_MODE)
#  if defined(CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED_120M)
#    if BOSS1_ESP32S3_SPI_TIMING_CORE_CLOCK_DIV == 1
#      define BOSS1_ESP32S3_SPI_TIMING_PSRAM_CORE_CLK     120
#    elif BOSS1_ESP32S3_SPI_TIMING_CORE_CLOCK_DIV == 2
#      define BOSS1_ESP32S3_SPI_TIMING_PSRAM_CORE_CLK     240
#    endif
#  endif
#endif

#if BOSS1_ESP32S3_SPI_TIMING_FLASH_TUNING
#  if BOSS1_ESP32S3_SPI_TIMING_PSRAM_TUNING
#    if BOSS1_ESP32S3_SPI_TIMING_FLASH_CORE_CLK != BOSS1_ESP32S3_SPI_TIMING_PSRAM_CORE_CLK
#      error "FLASH and PSRAM Mode configuration are not supported"
#    endif
#    define BOSS1_ESP32S3_SPI_TIMING_CORE_CLK     BOSS1_ESP32S3_SPI_TIMING_FLASH_CORE_CLK
#  else
#    if BOSS1_ESP32S3_SPI_TIMING_FLASH_CORE_CLK % BOSS1_ESP32S3_SPI_TIMING_PSRAM_CLOCK != 0
#      error "FLASH and PSRAM Mode configuration are not supported"
#    endif
#    define BOSS1_ESP32S3_SPI_TIMING_CORE_CLK     BOSS1_ESP32S3_SPI_TIMING_FLASH_CORE_CLK
#  endif
#else
#  if BOSS1_ESP32S3_SPI_TIMING_PSRAM_TUNING
#    if BOSS1_ESP32S3_SPI_TIMING_PSRAM_CORE_CLK % BOSS1_ESP32S3_SPI_TIMING_FLASH_CLOCK != 0
#      error "FLASH and PSRAM Mode configuration are not supported"
#    endif
#    define BOSS1_ESP32S3_SPI_TIMING_CORE_CLK     BOSS1_ESP32S3_SPI_TIMING_PSRAM_CORE_CLK
#  else
#    define BOSS1_ESP32S3_SPI_TIMING_CORE_CLK     80
#  endif
#endif

#define BOSS1_ESP32S3_CHECK_POWER_OF_2(n)         ((((n) & ((~(n)) + 1))) == (n))

#ifdef CONFIG_BOSS1_ESP32S3_FLASH_SAMPLE_MODE_DTR
#  if BOSS1_ESP32S3_CHECK_POWER_OF_2(BOSS1_ESP32S3_SPI_TIMING_CORE_CLK / BOSS1_ESP32S3_SPI_TIMING_FLASH_CLOCK) == 0
#    error "FLASH and PSRAM Mode configuration are not supported"
#  endif
#endif

#ifdef CONFIG_BOSS1_ESP32S3_SPIRAM_MODE_OCT
#  if BOSS1_ESP32S3_CHECK_POWER_OF_2(BOSS1_ESP32S3_SPI_TIMING_CORE_CLK / BOSS1_ESP32S3_SPI_TIMING_PSRAM_CLOCK) == 0
#    error "FLASH and PSRAM Mode configuration are not supported"
#  endif
#endif

#if BOSS1_ESP32S3_SPI_TIMING_CORE_CLK == 80
#  define DEFAULT_CORE_CLOCK    CORE_CLOCK_80M
#  define DEFAULT_CORE_CLK_REG  CORE_CLK_REG_SEL_80M
#elif BOSS1_ESP32S3_SPI_TIMING_CORE_CLK == 120
#  define DEFAULT_CORE_CLOCK    CORE_CLOCK_120M
#  define DEFAULT_CORE_CLK_REG  CORE_CLK_REG_SEL_120M
#elif BOSS1_ESP32S3_SPI_TIMING_CORE_CLK == 160
#  define DEFAULT_CORE_CLOCK    CORE_CLOCK_160M
#  define DEFAULT_CORE_CLK_REG  CORE_CLK_REG_SEL_160M
#elif BOSS1_ESP32S3_SPI_TIMING_CORE_CLK == 240
...
#if defined(CONFIG_BOSS1_ESP32S3_FLASH_FREQ_20M)
#  define FLASH_CLOCK_DIVIDER (BOSS1_ESP32S3_SPI_TIMING_CORE_CLK / 20)
#elif defined(CONFIG_BOSS1_ESP32S3_FLASH_FREQ_40M)
#  define FLASH_CLOCK_DIVIDER (BOSS1_ESP32S3_SPI_TIMING_CORE_CLK / 40)
#elif defined(CONFIG_BOSS1_ESP32S3_FLASH_FREQ_80M)
#  define FLASH_CLOCK_DIVIDER (BOSS1_ESP32S3_SPI_TIMING_CORE_CLK / 80)
#elif defined(CONFIG_BOSS1_ESP32S3_FLASH_FREQ_120M)
#  define FLASH_CLOCK_DIVIDER (BOSS1_ESP32S3_SPI_TIMING_CORE_CLK / 120)
#else
#  error "SPI timing flash clock is invalid"
#endif

#if defined(CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED_40M)
#  define PSRAM_CLOCK_DIVIDER (BOSS1_ESP32S3_SPI_TIMING_CORE_CLK / 40)
#elif defined(CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED_80M)
#  define PSRAM_CLOCK_DIVIDER (BOSS1_ESP32S3_SPI_TIMING_CORE_CLK / 80)
#elif defined(CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED_120M)
#  define PSRAM_CLOCK_DIVIDER (BOSS1_ESP32S3_SPI_TIMING_CORE_CLK / 120)
#else
...
#define MSPI_TIMING_PSRAM_DTR_MODE           CONFIG_BOSS1_ESP32S3_SPIRAM_MODE_OCT
#define MSPI_TIMING_PSRAM_STR_MODE           !CONFIG_BOSS1_ESP32S3_SPIRAM_MODE_OCT
#define MSPI_TIMING_FLASH_DTR_MODE           CONFIG_BOSS1_ESP32S3_FLASH_SAMPLE_MODE_DTR
#define MSPI_TIMING_FLASH_STR_MODE           CONFIG_BOSS1_ESP32S3_FLASH_SAMPLE_MODE_STR
...
#if BOSS1_ESP32S3_SPI_TIMING_FLASH_TUNING || BOSS1_ESP32S3_SPI_TIMING_PSRAM_TUNING
...
#if CONFIG_BOSS1_ESP32S3_SPIRAM_MODE_QUAD
...
static void set_flash_extra_dummy(uint8_t spi_num, uint8_t extra_dummy)
{
#ifdef CONFIG_BOSS1_ESP32S3_FLASH_MODE_OCT
  if (extra_dummy > 0)
    {
...
static void set_psram_extra_dummy(uint8_t spi_num, uint8_t extra_dummy)
{
#if CONFIG_BOSS1_ESP32S3_SPIRAM_MODE_OCT
...
#elif CONFIG_BOSS1_ESP32S3_SPIRAM_MODE_QUAD
...
#if CONFIG_BOSS1_ESP32S3_FLASH_FREQ_20M
    *config = MSPI_TIMING_FLASH_GET_TUNING_CONFIG(
                BOSS1_ESP32S3_SPI_TIMING_CORE_CLK, 20, FLASH_MODE);
#elif CONFIG_BOSS1_ESP32S3_FLASH_FREQ_40M
    *config = MSPI_TIMING_FLASH_GET_TUNING_CONFIG(
                BOSS1_ESP32S3_SPI_TIMING_CORE_CLK, 40, FLASH_MODE);
#elif CONFIG_BOSS1_ESP32S3_FLASH_FREQ_80M
    *config = MSPI_TIMING_FLASH_GET_TUNING_CONFIG(
                BOSS1_ESP32S3_SPI_TIMING_CORE_CLK, 80, FLASH_MODE);
#elif CONFIG_BOSS1_ESP32S3_FLASH_FREQ_120M
    *config = MSPI_TIMING_FLASH_GET_TUNING_CONFIG(
                BOSS1_ESP32S3_SPI_TIMING_CORE_CLK, 120, FLASH_MODE);
#endif
...
#if CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED_40M
    *config = MSPI_TIMING_PSRAM_GET_TUNING_CONFIG(
                BOSS1_ESP32S3_SPI_TIMING_CORE_CLK, 40, PSRAM_MODE);
#elif CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED_80M
    *config = MSPI_TIMING_PSRAM_GET_TUNING_CONFIG(
                BOSS1_ESP32S3_SPI_TIMING_CORE_CLK, 80, PSRAM_MODE);
#elif CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED_120M
    *config = MSPI_TIMING_PSRAM_GET_TUNING_CONFIG(
                BOSS1_ESP32S3_SPI_TIMING_CORE_CLK, 120, PSRAM_MODE);
#endif
...
static uint32_t select_best_tuning_config_str(tuning_config_s *config,
                          uint32_t consecutive_length, uint32_t end)
{
#if (BOSS1_ESP32S3_SPI_TIMING_CORE_CLK == 120 || BOSS1_ESP32S3_SPI_TIMING_CORE_CLK == 240)
...
static uint32_t select_best_tuning_config_dtr(tuning_config_s *config,
                           uint32_t consecutive_length, uint32_t end)
{
#if (BOSS1_ESP32S3_SPI_TIMING_CORE_CLK == 160)
