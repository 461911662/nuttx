...
#if defined(CONFIG_BOSS1_ESP32S3_TWAI)
...
#  ifndef CONFIG_BOSS1_ESP32S3_TWAI_BITRATE
#    error "CONFIG_BOSS1_ESP32S3_TWAI_BITRATE is not defined"
#  endif

/* If no sample point is provided, use a sample point of 80 */

#  ifndef CONFIG_BOSS1_ESP32S3_TWAI_SAMPLEP
#    define CONFIG_BOSS1_ESP32S3_TWAI_SAMPLEP 80
#  endif
#endif

/* If no Synchronization Jump Width is provided, use a SJW of 13 */

#ifndef CONFIG_BOSS1_ESP32S3_TWAI_SJW
#  define CONFIG_BOSS1_ESP32S3_TWAI_SJW 3
#endif
...
#  undef CONFIG_BOSS1_ESP32S3_TWAI_REGDEBUG
#endif
...
#ifdef CONFIG_BOSS1_ESP32S3_TWAI_REGDEBUG
...
static struct twai_dev_s g_twaipriv =
{
  ...
  .port             = 0,
  .periph           = BOSS1_ESP32S3_PERIPH_TWAI,
  .irq              = BOSS1_ESP32S3_IRQ_TWAI,
  .cpuint           = -ENOMEM,
  .bitrate          = CONFIG_BOSS1_ESP32S3_TWAI_BITRATE,
  .samplep          = CONFIG_BOSS1_ESP32S3_TWAI_SAMPLEP,
  .sjw              = CONFIG_BOSS1_ESP32S3_TWAI_SJW,
...
struct can_dev_s *esp32s3_twaiinitialize(void)
{
  ...
  esp32s3_configgpio(CONFIG_BOSS1_ESP32S3_TWAI_TXPIN, OUTPUT_FUNCTION_2);
  esp32s3_gpio_matrix_out(CONFIG_BOSS1_ESP32S3_TWAI_TXPIN, TWAI_TX_IDX, 0, 0);

  esp32s3_configgpio(CONFIG_BOSS1_ESP32S3_TWAI_RXPIN, INPUT_FUNCTION_2);
  esp32s3_gpio_matrix_in(CONFIG_BOSS1_ESP32S3_TWAI_RXPIN, TWAI_RX_IDX, 0);
