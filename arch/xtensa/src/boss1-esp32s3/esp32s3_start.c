...
#if defined(CONFIG_BOSS1_ESP32S3_APP_FORMAT_MCUBOOT) || \
    defined (CONFIG_ESPRESSIF_SIMPLE_BOOT)
#  ifdef CONFIG_BOSS1_ESP32S3_APP_FORMAT_MCUBOOT
#    define PRIMARY_SLOT_OFFSET   CONFIG_BOSS1_ESP32S3_OTA_PRIMARY_SLOT_OFFSET
#  else
...
extern void cache_set_idrom_mmu_info(uint32_t instr_page_num,
                                     ...
                                     int i_off,
                                     int ro_off);
#ifdef CONFIG_BOSS1_ESP32S3_DATA_CACHE_16KB
...
noinstrument_function static void IRAM_ATTR configure_cpu_caches(void)
{
  ...
  rom_config_instruction_cache_mode(CONFIG_BOSS1_ESP32S3_INSTRUCTION_CACHE_SIZE,
                                CONFIG_BOSS1_ESP32S3_ICACHE_ASSOCIATED_WAYS,
                                CONFIG_BOSS1_ESP32S3_INSTRUCTION_CACHE_LINE_SIZE);
  ...
  rom_config_data_cache_mode(CONFIG_BOSS1_ESP32S3_DATA_CACHE_SIZE,
                             CONFIG_BOSS1_ESP32S3_DCACHE_ASSOCIATED_WAYS,
                             CONFIG_BOSS1_ESP32S3_DATA_CACHE_LINE_SIZE);
...
#if defined(CONFIG_BOSS1_ESP32S3_FLASH_MODE_OCT) || \
...
#ifdef CONFIG_BOSS1_ESP32S3_SYSTEM_BBPLL_RECALIB
  esp32s3_rtc_recalib_bbpll();
#endif

  esp32s3_spi_timing_set_mspi_flash_tuning();
#if defined(CONFIG_BOSS1_ESP32S3_SPIRAM_BOOT_INIT)
  if (esp_spiram_init() != OK)
    {
#  if defined(BOSS1_ESP32S3_SPIRAM_IGNORE_NOTFOUND)
...
#if defined(CONFIG_BOSS1_ESP32S3_DMA)
