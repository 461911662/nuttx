...
#define QSPI_DMA_BUFSIZE CONFIG_BOSS1_ESP32S3_SPI_DMA_BUFSIZE

/* QSPI DMA RX/TX number of descriptors */

#  if (QSPI_DMA_BUFSIZE % BOSS1_ESP32S3_DMA_BUFLEN_MAX) > 0
#    define QSPI_DMA_DESC_NUM (QSPI_DMA_BUFSIZE / BOSS1_ESP32S3_DMA_BUFLEN_MAX + 1)
#  else
#    define QSPI_DMA_DESC_NUM (QSPI_DMA_BUFSIZE / BOSS1_ESP32S3_DMA_BUFLEN_MAX)
#  endif
...
#  define QSPI_IS_CS_IOMUX    (CONFIG_BOSS1_ESP32S3_SPI2_CSPIN == SPI2_IOMUX_CSPIN)
#  define QSPI_IS_CLK_IOMUX   (CONFIG_BOSS1_ESP32S3_SPI2_CLKPIN == SPI2_IOMUX_CLKPIN)
#  define QSPI_IS_MOSI_IOMUX  (CONFIG_BOSS1_ESP32S3_SPI2_MOSIPIN == SPI2_IOMUX_MOSIPIN)
#  define QSPI_IS_MISO_IOMUX  (CONFIG_BOSS1_ESP32S3_SPI2_MISOPIN == SPI2_IOMUX_MISOPIN)
#  define QSPI_IS_IO2_IOMUX   (CONFIG_BOSS1_ESP32S3_SPI2_IO2PIN == SPI2_IOMUX_WPPIN)
#  define QSPI_IS_IO3_IOMUX   (CONFIG_BOSS1_ESP32S3_SPI2_IO3PIN == SPI2_IOMUX_HDPIN)
...
#if QSPI_VIA_IOMUX == 0 || defined(CONFIG_BOSS1_ESP32S3_SPI3)
...
#endif /* CONFIG_BOSS1_ESP32S3_SPI */
