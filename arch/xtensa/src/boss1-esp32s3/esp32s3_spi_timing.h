...
#ifndef __ARCH_XTENSA_SRC_BOSS1_ESP32S3_BOSS1_ESP32S3_SPI_TIMING_H
#define __ARCH_XTENSA_SRC_BOSS1_ESP32S3_BOSS1_ESP32S3_SPI_TIMING_H
...
#  define BOSS1_ESP32S3_SPI_TIMING_FLASH_CLOCK            20
#elif defined(CONFIG_BOSS1_ESP32S3_FLASH_FREQ_40M)
#  define BOSS1_ESP32S3_SPI_TIMING_FLASH_CLOCK            40
#elif defined(CONFIG_BOSS1_ESP32S3_FLASH_FREQ_80M)
#  define BOSS1_ESP32S3_SPI_TIMING_FLASH_CLOCK            80
#elif defined(CONFIG_BOSS1_ESP32S3_FLASH_FREQ_120M)
#  define BOSS1_ESP32S3_SPI_TIMING_FLASH_CLOCK            120
#endif

#if defined(CONFIG_BOSS1_ESP32S3_FLASH_SAMPLE_MODE_DTR)
#  if BOSS1_ESP32S3_SPI_TIMING_FLASH_CLOCK > 40
#    define BOSS1_ESP32S3_SPI_TIMING_FLASH_TUNING         1
#  else
#    define BOSS1_ESP32S3_SPI_TIMING_FLASH_TUNING         0
#  endif
#elif defined(CONFIG_BOSS1_ESP32S3_FLASH_SAMPLE_MODE_STR)
#  if BOSS1_ESP32S3_SPI_TIMING_FLASH_CLOCK > 80
#    define BOSS1_ESP32S3_SPI_TIMING_FLASH_TUNING         1
#  else
#    define BOSS1_ESP32S3_SPI_TIMING_FLASH_TUNING         0
#  endif
...
#    define BOSS1_ESP32S3_SPI_TIMING_PSRAM_CLOCK          40
#  elif defined(CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED_80M)
#    define BOSS1_ESP32S3_SPI_TIMING_PSRAM_CLOCK          80
#  elif defined(CONFIG_BOSS1_ESP32S3_SPIRAM_SPEED_120M)
#    define BOSS1_ESP32S3_SPI_TIMING_PSRAM_CLOCK          120
#  endif
#else
#  define BOSS1_ESP32S3_SPI_TIMING_PSRAM_CLOCK            10
#endif

#if defined(CONFIG_BOSS1_ESP32S3_SPIRAM_MODE_OCT)
#  if BOSS1_ESP32S3_SPI_TIMING_PSRAM_CLOCK > 40
#    define BOSS1_ESP32S3_SPI_TIMING_PSRAM_TUNING         1
#  else
#    define BOSS1_ESP32S3_SPI_TIMING_PSRAM_TUNING         0
#  endif
#elif defined(CONFIG_BOSS1_ESP32S3_SPIRAM_MODE_QUAD)
#  if BOSS1_ESP32S3_SPI_TIMING_PSRAM_CLOCK > 80
#    define BOSS1_ESP32S3_SPI_TIMING_PSRAM_TUNING         1
#  else
#    define BOSS1_ESP32S3_SPI_TIMING_PSRAM_TUNING         0
#  endif
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_XTENSA_SRC_BOSS1_ESP32S3_BOSS1_ESP32S3_SPI_H */
