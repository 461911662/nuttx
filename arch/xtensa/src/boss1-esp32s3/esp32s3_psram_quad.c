...
#define PSRAM_CLK_IO          CONFIG_BOSS1_ESP32S3_DEFAULT_PSRAM_CLK_IO /* Default value is 30 */
#define PSRAM_CS_IO           CONFIG_BOSS1_ESP32S3_DEFAULT_PSRAM_CS_IO  /* Default value is 26 */
