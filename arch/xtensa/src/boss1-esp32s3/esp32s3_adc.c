...
#if defined(CONFIG_BOSS1_ESP32S3_ADC_VOL_950)
...
#elif defined(CONFIG_BOSS1_ESP32S3_ADC_VOL_1250)
...
#elif defined(CONFIG_BOSS1_ESP32S3_ADC_VOL_1750)
...
#elif defined(CONFIG_BOSS1_ESP32S3_ADC_VOL_3100)
...
#ifdef CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL0
...
#ifdef CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL1
...
#ifdef CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL2
...
#ifdef CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL3
...
#ifdef CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL4
...
#ifdef CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL5
...
#ifdef CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL6
...
#ifdef CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL7
...
#ifdef CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL8
...
#ifdef CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL9
...
void esp32s3_adc_init(int adc_index, struct adc_dev_s *dev)
{
  ...
  switch (adc_index)
    {
#if defined(CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL0)
      case 0:
          dev->ad_priv = &g_adc1_chan0;
        break;
#endif

#if defined(CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL1)
      case 1:
          dev->ad_priv = &g_adc1_chan1;
        break;
#endif

#if defined(CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL2)
      case 2:
          dev->ad_priv = &g_adc1_chan2;
        break;
#endif

#if defined(CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL3)
      case 3:
          dev->ad_priv = &g_adc1_chan3;
        break;
#endif

#if defined(CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL4)
      case 4:
          dev->ad_priv = &g_adc1_chan4;
        break;
#endif

#if defined(CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL5)
      case 5:
          dev->ad_priv = &g_adc1_chan5;
        break;
#endif

#if defined(CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL6)
      case 6:
          dev->ad_priv = &g_adc1_chan6;
        break;
#endif

#if defined(CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL7)
      case 7:
          dev->ad_priv = &g_adc1_chan7;
        break;
#endif

#if defined(CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL8)
      case 8:
          dev->ad_priv = &g_adc1_chan8;
        break;
#endif

#if defined(CONFIG_BOSS1_ESP32S3_ADC1_CHANNEL9)
      case 9:
