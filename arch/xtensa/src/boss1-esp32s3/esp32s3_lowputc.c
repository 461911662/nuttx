...
#ifdef CONFIG_BOSS1_ESP32S3_UART0

struct esp32s3_uart_s g_uart0_config =
{
  .periph = BOSS1_ESP32S3_PERIPH_UART0,
  .id = 0,
  .cpuint = -ENOMEM,
  .irq = BOSS1_ESP32S3_IRQ_UART0,
  .baud = CONFIG_UART0_BAUD,
  .bits = CONFIG_UART0_BITS,
  .parity = CONFIG_UART0_PARITY,
  .stop_b2 = CONFIG_UART0_2STOP,
  .int_pri = BOSS1_ESP32S3_INT_PRIO_DEF,
  .txpin = CONFIG_BOSS1_ESP32S3_UART0_TXPIN,
  .txsig = U0TXD_OUT_IDX,
  .rxpin = CONFIG_BOSS1_ESP32S3_UART0_RXPIN,
  .rxsig = U0RXD_IN_IDX,
#ifdef CONFIG_SERIAL_IFLOWCONTROL
  .rtspin = CONFIG_BOSS1_ESP32S3_UART0_RTSPIN,
  ...
  .ctspin = CONFIG_BOSS1_ESP32S3_UART0_CTSPIN,
  .ctssig = U0CTS_IN_IDX,
...
#endif
#endif
#ifdef CONFIG_BOSS1_ESP32S3_UART0_RS485
  .rs485_dir_gpio = CONFIG_BOSS1_ESP32S3_UART0_RS485_DIR_PIN,
#if (CONFIG_BOSS1_ESP32S3_UART0_RS485_DIR_POLARITY == 0)
...
#endif /* CONFIG_BOSS1_ESP32S3_UART0 */

#ifdef CONFIG_BOSS1_ESP32S3_UART1

struct esp32s3_uart_s g_uart1_config =
{
  .periph = BOSS1_ESP32S3_PERIPH_UART1,
  .id = 1,
  .cpuint = -ENOMEM,
  .irq = BOSS1_ESP32S3_IRQ_UART1,
  .baud = CONFIG_UART1_BAUD,
  .bits = CONFIG_UART1_BITS,
  .parity = CONFIG_UART1_PARITY,
  .stop_b2 = CONFIG_UART1_2STOP,
  .int_pri = BOSS1_ESP32S3_INT_PRIO_DEF,
  .txpin = CONFIG_BOSS1_ESP32S3_UART1_TXPIN,
  .txsig = U1TXD_OUT_IDX,
  .rxpin = CONFIG_BOSS1_ESP32S3_UART1_RXPIN,
  .rxsig = U1RXD_IN_IDX,
#ifdef CONFIG_SERIAL_IFLOWCONTROL
  .rtspin = CONFIG_BOSS1_ESP32S3_UART1_RTSPIN,
...
#endif
#ifdef CONFIG_SERIAL_OFLOWCONTROL
  .ctspin = CONFIG_BOSS1_ESP32S3_UART1_CTSPIN,
  .ctssig = U1CTS_IN_IDX,
...
#endif
#endif
#ifdef CONFIG_BOSS1_ESP32S3_UART1_RS485
  .rs485_dir_gpio = CONFIG_BOSS1_ESP32S3_UART1_RS485_DIR_PIN,
#if (CONFIG_BOSS1_ESP32S3_UART1_RS485_DIR_POLARITY == 0)
  .rs485_dir_polarity = false,
#else
  .rs485_dir_polarity = true,
#endif
...
#endif /* CONFIG_BOSS1_ESP32S3_UART1 */

#ifdef CONFIG_BOSS1_ESP32S3_UART2

struct esp32s3_uart_s g_uart2_config =
{
  .periph = BOSS1_ESP32S3_PERIPH_UART2,
  .id = 2,
  .cpuint = -ENOMEM,
  .irq = BOSS1_ESP32S3_IRQ_UART2,
  .baud = CONFIG_UART2_BAUD,
  .bits = CONFIG_UART2_BITS,
  .parity = CONFIG_UART2_PARITY,
  .stop_b2 = CONFIG_UART2_2STOP,
  .int_pri = BOSS1_ESP32S3_INT_PRIO_DEF,
  .txpin = CONFIG_BOSS1_ESP32S3_UART2_TXPIN,
  .txsig = U2TXD_OUT_IDX,
  .rxpin = CONFIG_BOSS1_ESP32S3_UART2_RXPIN,
  .rxsig = U2RXD_IN_IDX,
#ifdef CONFIG_SERIAL_IFLOWCONTROL
  .rtspin = CONFIG_BOSS1_ESP32S3_UART2_RTSPIN,
...
#endif
#ifdef CONFIG_SERIAL_OFLOWCONTROL
  .ctspin = CONFIG_BOSS1_ESP32S3_UART2_CTSPIN,
  .ctssig = U2CTS_IN_IDX,
#ifdef CONFIG_UART1_OFLOWCONTROL
  .oflow = true,    /* output flow control (CTS) enabled */
#else
...
#endif
#endif
#ifdef CONFIG_BOSS1_ESP32S3_UART2_RS485
  .rs485_dir_gpio = CONFIG_BOSS1_ESP32S3_UART2_RS485_DIR_PIN,
#if (CONFIG_BOSS1_ESP32S3_UART2_RS485_DIR_POLARITY == 0)
  .rs485_dir_polarity = false,
#else
  .rs485_dir_polarity = true,
#endif
...
#endif /* CONFIG_BOSS1_ESP32S3_UART2 */
