...
#ifndef __ARCH_XTENSA_SRC_BOSS1_ESP32S3_BOSS1_ESP32S3_DMA_H
#define __ARCH_XTENSA_SRC_BOSS1_ESP32S3_BOSS1_ESP32S3_DMA_H
...
#define BOSS1_ESP32S3_DMA_BUFFER_MAX_SIZE       (0x1000 - 1)

/* DMA max data length, and aligned to 4Bytes */

#define BOSS1_ESP32S3_DMA_BUFLEN_MAX_4B_ALIGNED (0x1000 - 4)

/* DMA max buffer length */

#define BOSS1_ESP32S3_DMA_BUFLEN_MAX        BOSS1_ESP32S3_DMA_BUFFER_MAX_SIZE

/* DMA channel number */

#define BOSS1_ESP32S3_DMA_CHAN_MAX          (5)

/* DMA RX MAX priority */

#define BOSS1_ESP32S3_DMA_RX_PRIO_MAX       (15)

/* DMA TX MAX priority */

#define BOSS1_ESP32S3_DMA_TX_PRIO_MAX       (15)

/* DMA descriptor */

#define BOSS1_ESP32S3_DMA_CTRL_OWN          (1 << 31)   /* Owned by DMA */
#define BOSS1_ESP32S3_DMA_CTRL_EOF          (1 << 30)   /* End of frame */
#define BOSS1_ESP32S3_DMA_CTRL_ERREOF       (1 << 28)   /* Received data error */
#define BOSS1_ESP32S3_DMA_CTRL_DATALEN_S    (12)        /* Data length shift */
#define BOSS1_ESP32S3_DMA_CTRL_DATALEN_V    (0xfff)     /* Data length value */
#define BOSS1_ESP32S3_DMA_CTRL_BUFLEN_S     (0)         /* Buffer length shift */
#define BOSS1_ESP32S3_DMA_CTRL_BUFLEN_V     (0xfff)     /* Buffer length value */
...
{
  BOSS1_ESP32S3_DMA_PERIPH_MEM    = -1,
  BOSS1_ESP32S3_DMA_PERIPH_SPI2   = 0,
  BOSS1_ESP32S3_DMA_PERIPH_SPI3   = 1,
  BOSS1_ESP32S3_DMA_PERIPH_UCHI0  = 2,
  BOSS1_ESP32S3_DMA_PERIPH_I2S0   = 3,
  BOSS1_ESP32S3_DMA_PERIPH_I2S1   = 4,
  BOSS1_ESP32S3_DMA_PERIPH_LCDCAM = 5,
  BOSS1_ESP32S3_DMA_PERIPH_AES    = 6,
  BOSS1_ESP32S3_DMA_PERIPH_SHA    = 7,
  BOSS1_ESP32S3_DMA_PERIPH_ADC    = 8,
  BOSS1_ESP32S3_DMA_PERIPH_RMT    = 9,
  BOSS1_ESP32S3_DMA_PERIPH_NUM,
};

enum esp32s3_dma_ext_memblk_e
{
  BOSS1_ESP32S3_DMA_EXT_MEMBLK_16B = 0,
  BOSS1_ESP32S3_DMA_EXT_MEMBLK_32B = 1,
  BOSS1_ESP32S3_DMA_EXT_MEMBLK_64B = 2
};
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_XTENSA_SRC_BOSS1_ESP32S3_BOSS1_ESP32S3_DMA_H */
