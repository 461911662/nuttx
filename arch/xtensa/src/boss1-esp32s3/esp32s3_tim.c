...
{
  BOSS1_ESP32S3_TIM_GROUP0 = 0,  /* Timer Group 0 */
  BOSS1_ESP32S3_TIM_GROUP1,      /* Timer Group 1 */
};
...
{
  BOSS1_ESP32S3_TIM_TIMER0 = 0,  /* Timer 0 */
  BOSS1_ESP32S3_TIM_TIMER1,      /* Timer 1 */
};
...
{
  .ops      = &esp32s3_tim_ops,
  .gid      = BOSS1_ESP32S3_TIM_GROUP0,
  .tid      = BOSS1_ESP32S3_TIM_TIMER0,
  .periph   = BOSS1_ESP32S3_PERIPH_TG_T0_LEVEL,
  .irq      = BOSS1_ESP32S3_IRQ_TG_T0_LEVEL,
  .cpuint   = -ENOMEM,
  .core     = -ENODEV,
  .inuse    = false,
  .priority = 1,
...
struct esp32s3_tim_priv_s g_esp32s3_tim1_priv =
{
  .ops      = &esp32s3_tim_ops,
  .gid      = BOSS1_ESP32S3_TIM_GROUP0,
  .tid      = BOSS1_ESP32S3_TIM_TIMER1,
  .periph   = BOSS1_ESP32S3_PERIPH_TG_T1_LEVEL,
  .irq      = BOSS1_ESP32S3_IRQ_TG_T1_LEVEL,
  .cpuint   = -ENOMEM,
  .core     = -ENODEV,
  .inuse    = false,
  .priority = 1,
...
{
  .ops      = &esp32s3_tim_ops,
  .gid      = BOSS1_ESP32S3_TIM_GROUP1,
  .tid      = BOSS1_ESP32S3_TIM_TIMER0,
  .periph   = BOSS1_ESP32S3_PERIPH_TG1_T0_LEVEL,
  .irq      = BOSS1_ESP32S3_IRQ_TG1_T0_LEVEL,
  .cpuint   = -ENOMEM,
  .core     = -ENODEV,
  .inuse    = false,
  .priority = 1,
...
struct esp32s3_tim_priv_s g_esp32s3_tim3_priv =
{
  ...
  .gid      = BOSS1_ESP32S3_TIM_GROUP1,
  .tid      = BOSS1_ESP32S3_TIM_TIMER1,
  .periph   = BOSS1_ESP32S3_PERIPH_TG1_T1_LEVEL,
  .irq      = BOSS1_ESP32S3_IRQ_TG1_T1_LEVEL,
  .cpuint   = -ENOMEM,
  .core     = -ENODEV,
  .inuse    = false,
  .priority = 1,
...
static void tim_start(struct esp32s3_tim_dev_s *dev)
{
  ...
  if (priv->tid == BOSS1_ESP32S3_TIM_TIMER0)
    {
                        ...
                        enum esp32s3_tim_mode_e mode)
{
  ...
  if (mode == BOSS1_ESP32S3_TIM_MODE_DOWN)
    {
      if (priv->tid == BOSS1_ESP32S3_TIM_TIMER0)
        {
  ...
  else if (mode == BOSS1_ESP32S3_TIM_MODE_UP)
    {
      if (priv->tid == BOSS1_ESP32S3_TIM_TIMER0)
        {
                          ...
                          enum esp32s3_tim_clksrc_e src)
{
  ...
  if (src == BOSS1_ESP32S3_TIM_APB_CLK)
    {
      modifyreg32(TIMG_T0CONFIG_REG(priv->gid), TIMG_T0_USE_XTAL_M, 0);
    }
  else if (src == BOSS1_ESP32S3_TIM_XTAL_CLK)
    {
  ...
  /* Otherwise set callback and enable interrupt */
  ...
  else
    {
      ...
      priv->cpuint = esp32s3_setup_irq(priv->core, priv->periph,
                                       priv->priority, BOSS1_ESP32S3_CPUINT_LEVEL);
      if (priv->cpuint < 0)
        {
...
struct esp32s3_tim_dev_s *esp32s3_tim_init(int timer)
{
  ...
  if (tim->gid == BOSS1_ESP32S3_TIM_GROUP0)
    {
