...
#define USER_IMAGE_OFFSET   CONFIG_BOSS1_ESP32S3_KERNEL_OFFSET + CONFIG_BOSS1_ESP32S3_KERNEL_IMAGE_SIZE
...
#ifdef CONFIG_BOSS1_ESP32S3_INSTRUCTION_CACHE_16KB
...
#else /* CONFIG_BOSS1_ESP32S3_INSTRUCTION_CACHE_32KB */
...
void esp32s3_pmsirqinitialize(void)
{
  VERIFY(esp32s3_setup_irq(0,
                           BOSS1_ESP32S3_PERIPH_CORE_0_IRAM0_PMS_MONITOR_VIOLATE,
                           1, BOSS1_ESP32S3_CPUINT_LEVEL));
  VERIFY(esp32s3_setup_irq(0,
                           BOSS1_ESP32S3_PERIPH_CORE_0_DRAM0_PMS_MONITOR_VIOLATE,
                           1, BOSS1_ESP32S3_CPUINT_LEVEL));
  VERIFY(esp32s3_setup_irq(0, BOSS1_ESP32S3_PERIPH_CACHE_CORE0_ACS, 1,
                           BOSS1_ESP32S3_CPUINT_LEVEL));
  VERIFY(esp32s3_setup_irq(0, BOSS1_ESP32S3_PERIPH_CORE_0_PIF_PMS_MONITOR_VIOLATE,
                           1, BOSS1_ESP32S3_CPUINT_LEVEL));

  VERIFY(irq_attach(BOSS1_ESP32S3_IRQ_CORE_0_IRAM0_PMS_MONITOR_VIOLATE,
                    pms_violation_isr, NULL));
  VERIFY(irq_attach(BOSS1_ESP32S3_IRQ_CORE_0_DRAM0_PMS_MONITOR_VIOLATE,
                    pms_violation_isr, NULL));
  VERIFY(irq_attach(BOSS1_ESP32S3_IRQ_CACHE_CORE0_ACS, pms_violation_isr, NULL));
  VERIFY(irq_attach(BOSS1_ESP32S3_IRQ_CORE_0_PIF_PMS_MONITOR_VIOLATE,
                    pms_violation_isr, NULL));

  up_enable_irq(BOSS1_ESP32S3_IRQ_CORE_0_IRAM0_PMS_MONITOR_VIOLATE);
  up_enable_irq(BOSS1_ESP32S3_IRQ_CORE_0_DRAM0_PMS_MONITOR_VIOLATE);
  up_enable_irq(BOSS1_ESP32S3_IRQ_CACHE_CORE0_ACS);
  up_enable_irq(BOSS1_ESP32S3_IRQ_CORE_0_PIF_PMS_MONITOR_VIOLATE);
}
