...
#define MTD_BLK_SIZE                CONFIG_BOSS1_ESP32S3_SPIFLASH_MTD_BLKSIZE
...
#ifdef CONFIG_BOSS1_ESP32S3_SPI_FLASH_SUPPORT_PSRAM_STACK
...
#ifdef CONFIG_BOSS1_ESP32S3_STORAGE_MTD_DEBUG
