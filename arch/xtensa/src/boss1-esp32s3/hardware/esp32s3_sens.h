...
#ifndef __ARCH_XTENSA_SRC_BOSS1_ESP32S3_HARDWARE_BOSS1_ESP32S3_SENS_H
#define __ARCH_XTENSA_SRC_BOSS1_ESP32S3_HARDWARE_BOSS1_ESP32S3_SENS_H
...
#define SENS_SAR_TOUCH_DENOISE_REG         (DR_REG_SENS_BASE + 0x0060)
...
#define SENS_SAR_TOUCH_THRES1_REG          (DR_REG_SENS_BASE + 0x0064)
...
#define SENS_SAR_TOUCH_THRES2_REG          (DR_REG_SENS_BASE + 0x0068)
...
#define SENS_SAR_TOUCH_THRES3_REG          (DR_REG_SENS_BASE + 0x006c)
...
#define SENS_SAR_TOUCH_THRES4_REG          (DR_REG_SENS_BASE + 0x0070)
...
#define SENS_SAR_TOUCH_THRES5_REG          (DR_REG_SENS_BASE + 0x0074)
...
#define SENS_SAR_TOUCH_THRES6_REG          (DR_REG_SENS_BASE + 0x0078)
...
#define SENS_SAR_TOUCH_THRES7_REG          (DR_REG_SENS_BASE + 0x007c)
...
#define SENS_SAR_TOUCH_THRES8_REG          (DR_REG_SENS_BASE + 0x0080)
...
#define SENS_SAR_TOUCH_THRES9_REG          (DR_REG_SENS_BASE + 0x0084)
...
#define SENS_SAR_TOUCH_THRES10_REG          (DR_REG_SENS_BASE + 0x0088)
...
#define SENS_SAR_TOUCH_THRES11_REG          (DR_REG_SENS_BASE + 0x008c)
...
#define SENS_SAR_TOUCH_THRES12_REG          (DR_REG_SENS_BASE + 0x0090)
...
#define SENS_SAR_TOUCH_THRES13_REG          (DR_REG_SENS_BASE + 0x0094)
...
#define SENS_SAR_TOUCH_THRES14_REG          (DR_REG_SENS_BASE + 0x0098)
...
#define SENS_SAR_TOUCH_CHN_ST_REG          (DR_REG_SENS_BASE + 0x009c)
...
#define SENS_SAR_TOUCH_STATUS0_REG          (DR_REG_SENS_BASE + 0x00a0)
...
#define SENS_SAR_TOUCH_STATUS1_REG          (DR_REG_SENS_BASE + 0x00a4)
...
#define SENS_SAR_TOUCH_STATUS2_REG          (DR_REG_SENS_BASE + 0x00a8)
...
#define SENS_SAR_TOUCH_STATUS3_REG          (DR_REG_SENS_BASE + 0x00ac)
...
#define SENS_SAR_TOUCH_STATUS4_REG          (DR_REG_SENS_BASE + 0x00b0)
...
#define SENS_SAR_TOUCH_STATUS5_REG          (DR_REG_SENS_BASE + 0x00b4)
...
#define SENS_SAR_TOUCH_STATUS6_REG          (DR_REG_SENS_BASE + 0x00b8)
...
#define SENS_SAR_TOUCH_STATUS7_REG          (DR_REG_SENS_BASE + 0x00bc)
...
#define SENS_SAR_TOUCH_STATUS8_REG          (DR_REG_SENS_BASE + 0x00c0)
...
#define SENS_SAR_TOUCH_STATUS9_REG          (DR_REG_SENS_BASE + 0x00c4)
...
#define SENS_SAR_TOUCH_STATUS10_REG          (DR_REG_SENS_BASE + 0x00c8)
...
#define SENS_SAR_TOUCH_STATUS11_REG          (DR_REG_SENS_BASE + 0x00cc)
...
#define SENS_SAR_TOUCH_STATUS12_REG          (DR_REG_SENS_BASE + 0x00d0)
...
#define SENS_SAR_TOUCH_STATUS13_REG          (DR_REG_SENS_BASE + 0x00d4)
...
#define SENS_SAR_TOUCH_STATUS14_REG          (DR_REG_SENS_BASE + 0x00d8)
...
#define SENS_SAR_TOUCH_SLP_STATUS_REG          (DR_REG_SENS_BASE + 0x00dc)
...
#define SENS_SAR_TOUCH_APPR_STATUS_REG          (DR_REG_SENS_BASE + 0x00e0)
...
#define SENS_SAR_COCPU_STATE_REG        (DR_REG_SENS_BASE + 0x00e4)
...
#define SENS_SAR_COCPU_INT_RAW_REG          (DR_REG_SENS_BASE + 0x00e8)
...
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_RAW : RO
 * bitpos:[10] ;default: 1'b0 ;
 */
...
#define SENS_SAR_COCPU_INT_ENA_REG          (DR_REG_SENS_BASE + 0x00ec)
...
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA : R/W
 * bitpos:[10] ;default: 1'b0 ;
 */
...
#define SENS_SAR_COCPU_INT_ST_REG          (DR_REG_SENS_BASE + 0x00f0)
...
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ST : RO
 * bitpos:[10] ;default: 1'b0 ;
 */
...
#define SENS_SAR_COCPU_INT_CLR_REG          (DR_REG_SENS_BASE + 0x00f4)
...
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_CLR : WO
 * bitpos:[10] ;default: 1'b0 ;
 */
...
#define SENS_SAR_COCPU_DEBUG_REG          (DR_REG_SENS_BASE + 0x00f8)
...
#define SENS_SAR_HALL_CTRL_REG          (DR_REG_SENS_BASE + 0x00fc)
...
#define SENS_SAR_NOUSE_REG          (DR_REG_SENS_BASE + 0x0100)
...
#define SENS_SAR_PERI_CLK_GATE_CONF_REG          (DR_REG_SENS_BASE + 0x0104)
...
/* SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TS : WO
 * bitpos:[11] ;default: 1'b0 ;
 */
...
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TS : WO
 * bitpos:[10] ;default: 1'b0 ;
 */
...
/* SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TC : WO
 * bitpos:[11] ;default: 1'b0;
 */
...
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TC : WO
 * bitpos:[10] ;default: 1'b0 ;
 */
...
#define SENS_SARDATE_REG          (DR_REG_SENS_BASE + 0x01fc)
...
#endif /* __ARCH_XTENSA_SRC_BOSS1_ESP32S3_HARDWARE_BOSS1_ESP32S3_SENS_H */
