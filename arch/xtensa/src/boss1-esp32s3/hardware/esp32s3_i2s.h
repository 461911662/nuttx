/****************************************************************************
 * arch/xtensa/src/esp32s3/hardware/esp32s3_i2s.h
 *
...
#ifndef __ARCH_XTENSA_SRC_BOSS1_ESP32S3_HARDWARE_BOSS1_ESP32S3_I2S_H
#define __ARCH_XTENSA_SRC_BOSS1_ESP32S3_HARDWARE_BOSS1_ESP32S3_I2S_H
...
/* Description: The raw interrupt status bit  for the i2s_tx_hung_int
 * interrupt.
 */
...
/* Description: The raw interrupt status bit  for the i2s_rx_hung_int
 * interrupt.
 */
...
/* Description: The raw interrupt status bit  for the i2s_tx_done_int
 * interrupt.
 */
...
/* Description: The raw interrupt status bit  for the i2s_rx_done_int
 * interrupt.
 */
...
/* Description: The masked interrupt status bit  for the i2s_tx_hung_int
 * interrupt.
 */
...
/* Description: The masked interrupt status bit  for the i2s_rx_hung_int
 * interrupt.
 */
...
/* Description: The masked interrupt status bit  for the i2s_tx_done_int
 * interrupt.
 */
...
/* Description: The masked interrupt status bit  for the i2s_rx_done_int
 * interrupt.
 */
...
/* Description: The interrupt enable bit  for the i2s_tx_hung_int
 * interrupt.
 */
...
/* Description: The interrupt enable bit  for the i2s_rx_hung_int
 * interrupt.
 */
...
/* Description: The interrupt enable bit  for the i2s_tx_done_int
 * interrupt.
 */
...
/* Description: The interrupt enable bit  for the i2s_rx_done_int
 * interrupt.
 */
...
/* Description: Configure the down sampling rate of PDM RX filter group1
 * module.
 * 1: The  down sa mpling rate is 128.
...
/* Description: I2S Rx bit endian. 1:small endian, the LSB is received
 * first. 0:big endian, the MSB is received first..
 */
...
/* Description:
 * 0: WS should be 0 when receiving left channel data,
 * and WS is 1in right channel.
 * 1: WS should be 1 when receiving left channel data, and WS is 0
 * in right channel.
 */
...
/* Description:
 * 1: store 24 channel bits to 32 bits.
 * 0: store 24 channel bits to 24 bits.
 */
...
/* Description:
 * 0: I2S Rx only stop when reg_rx_start is cleared.
 * 1: Stop when reg_rx_start is 0 or in_suc_eof is 1.
 * 2:  Stop I2S RX when reg_rx_start is 0 or RX FIFO is full.
 */
...
/* Description: Set this bit to bypass Compress/Decompress module
 * for received data..
 */
...
/* Description: I2S RX compress/decompress configuration bit.
 * 0 (atol): A-Law decompress,
 * 1 (ltoa) : A-Law compress,
 * 2 (utol) : u-Law decompress,
 * 3 (ltou) : u-Law compress.
 */
...
/* Description:
 * 1: The first channel data value is valid in I2S RX mono mode.
...
/* Description:
 * Set 1 to update I2S RX registers from APB clock domain to I2S RX clock
 * domain. This bit will be cleared by hardware after update register
 * done.
 */
...
/* Description: I2S Tx bit endian.
 * 1:small endian, the LSB is sent first.
 * 0:big endian, the MSB is sent first.
 */
...
/* Description:
 * 0: WS should be 0 when sending left channel data, and WS is 1 in
 * right channel.
 * 1: WS should be 1 when sending left channel data, and WS is 0 in
 * right channel.
 */
...
/* Description:
 * 1: Sent 32 bits in 24 channel bits mode.
 * 0: Sent 24 bits in 24 channel bits mode.
 */
...
/* Description: 1: I2S TX left alignment mode. 0: I2S TX right
 * alignment mode.
 */
...
/* Description: Set this bit to stop disable output BCK signal and WS
 * signal when tx FIFO is emtpy.
 */
...
/* Description: Set this bit to bypass Compress/Decompress module for
 * transmitted data.
 */
...
/* Description: I2S TX compress/decompress configuration bit.
 *  0 (atol): A-Law decompress,
 *  1 (ltoa) : A-Law compress,
 *  2 (utol) : u-Law decompress,
 *  3 (ltou) : u-Law compress.
...
/* Description:
 * 1: The first channel data value is valid in I2S TX mono mode.
 ...
 * channel data in I2S TX mono mode or TDM channel select mode.
 * 0: The invalid channel data is reg_i2s_single_data in I2S TX mono
 * mode or TDM channel select mode.
 */
...
/* Description: Set this bit to enable receiver in Phillips
 * standard mode.
 */
...
/* Description: Set the bits to configure the valid data bit length
 * of I2S receiver channel.
...
/* Description:  The width of rx_ws_out in TDM mode is
 * (I2S_RX_TDM_WS_WIDTH[6:0] +1) * T_bck.
 */
...
/* Description:
 * 1: BCK is not delayed to generate pos/neg edge in master mode.
...
/* Description: Set this bit to enable transmitter in Phillips
 * standard mode.
 */
...
/* Description:
 * Set the bits to configure the valid data bit length of I2S transmitter
 * channel.
 * 7: all the valid channel data is in 8-bit-mode.
 * 15: all the valid channel data is in 16-bit-mode.
 * 23: all the valid channel data is in 24-bit-mode.
...
/* Description:
 * The width of tx_ws_out in TDM mode is:
 * (I2S_TX_TDM_WS_WIDTH[6:0] +1) * T_bck.
 */
...
/* Description:
 * 0: Use I2S Tx module clock as I2S_MCLK_OUT.
 * 1: Use I2S Rx module clock as I2S_MCLK_OUT.
 */
...
/* Description:
 * Select I2S Rx module source clock.
 * 0: no clock.
 * 1: APLL.
 * 2: CLK160,
 * 3: I2S_MCLK_in.
...
/* Description:
 * Select I2S Tx module source clock.
 * 0: XTAL clock.
 * 1: APLL.
 * 2: CLK160.
 * 3: I2S_MCLK_in.
 ...
 * will be:  for b <= a/2, z * [x * n-div + (n+1)-div] + y * n-div.
...
/* Description:
 * For b <= a/2, the value of I2S_RX_CLKM_DIV_YN1 is 0.
 * For b > a/2, the value of I2S_RX_CLKM_DIV_YN1 is 1.
 */
...
/* Description:
 * For b <= a/2, the value of I2S_RX_CLKM_DIV_X is (a/b) - 1.
 * For b > a/2, the value of I2S_RX_CLKM_DIV_X is (a/(a-b)) - 1.
 */
...
/* Description:
 * For b <= a/2, the value of I2S_RX_CLKM_DIV_Y is (a%b).
 * For b > a/2, the value of I2S_RX_CLKM_DIV_Y is (a%(a-b)).
 */
...
/* Description:
 * For b <= a/2, the value of I2S_RX_CLKM_DIV_Z is b.
 * For b > a/2, the value of I2S_RX_CLKM_DIV_Z is (a-b).
 */
...
/* Description: For b <= a/2, the value of I2S_TX_CLKM_DIV_YN1 is 0.
 * For b > a/2, the value of I2S_TX_CLKM_DIV_YN1 is 1.
 */
...
/* Description:
 * For b <= a/2, the value of I2S_TX_CLKM_DIV_X is (a/b) - 1.
 * For b > a/2, the value of I2S_TX_CLKM_DIV_X is (a/(a-b)) - 1.
 */
...
/* Description: For b <= a/2, the value of I2S_TX_CLKM_DIV_Y is (a%b).
 * For b > a/2, the value of I2S_TX_CLKM_DIV_Y is (a%(a-b)).
 */
...
/* Description: For b <= a/2, the value of I2S_TX_CLKM_DIV_Z is b.
 * For b > a/2, the value of I2S_TX_CLKM_DIV_Z is (a-b).
 */
...
/* Description: I2S TX PDM sigmadelta scale shift number:
 * 0: /2,
 * 1: x1,
 * 2: x2,
 * 3: x4.
...
/* Description: I2S TX PDM bypass hp filter or not.
...
/* Description: The fourth parameter of PDM TX IIR_HP filter stage 1
 * is (504 + I2S_TX_IIR_HP_MULT12_0[2:0]).
 */
...
/* Description: The fourth parameter of PDM TX IIR_HP filter stage 2
 * is (504 + I2S_TX_IIR_HP_MULT12_5[2:0]).
 */
...
/* Description:
 * 1: Enable the valid data input of I2S RX TDM channel $n.
...
/* Description:
 * 1: Enable the valid data input of I2S RX TDM or PDM channel $n.
 * 0:  Disable, just input 0 in this channel..
 */
...
/* Description:
 * 1: Enable the valid data output of I2S TX TDM channel $n.
...
/* Description:
 * The delay mode of I2S TX BCK input signal.
 * 0: bypass.
 * 1: delay by pos edge.
 * 2: delay by neg edge.
 * 3: not used..
...
/* Description:
 * The delay mode of I2S TX WS input signal.
 * 0: bypass.
 * 1: delay by pos edge.
 * 2: delay by neg edge.
 * 3: not used..
...
/* Description:
 * The delay mode of I2S TX BCK output signal.
 * 0: bypass.
 * 1: delay by pos edge.
 * 2: delay by neg edge.
 * 3: not used.
...
/* Description:
 * The delay mode of I2S TX WS output signal.
 * 0: bypass.
 * 1: delay by pos edge.
 * 2: delay by neg edge.
 * 3: not used..
...
/* Description:
 * The delay mode of I2S TX SD1 output signal.
 * 0: bypass.
 * 1: delay by pos edge.
 * 2: delay by neg edge.
 * 3: not used..
...
/* Description:
 * The delay mode of I2S TX SD output signal.
 * 0: bypass.
 * 1: delay by pos edge.
 * 2: delay by neg edge.
 * 3: not used..
...
/* Description:
 * The receive data bit length is
 * (I2S_RX_BITS_MOD[4:0] + 1) * (REG_RX_EOF_NUM[11:0] + 1). It will trigger
 * in_suc_eof interrupt in the configured DMA RX channel.
 */
...
#endif /* __ARCH_XTENSA_SRC_BOSS1_ESP32S3_HARDWARE_BOSS1_ESP32S3_I2S_H */
