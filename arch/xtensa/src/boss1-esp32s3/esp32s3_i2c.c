...
#define BOSS1_ESP32S3_I2CTIMEOTICKS \
    (SEC2TICK(CONFIG_BOSS1_ESP32S3_I2CTIMEOSEC) + MSEC2TICK(CONFIG_BOSS1_ESP32S3_I2CTIMEOMS))
...
static const struct esp32s3_i2c_config_s g_esp32s3_i2c0_config =
{
  ...
  .scl_pin    = CONFIG_BOSS1_ESP32S3_I2C0_SCLPIN,
  .sda_pin    = CONFIG_BOSS1_ESP32S3_I2C0_SDAPIN,
#ifndef CONFIG_I2C_POLLED
  .periph     = BOSS1_ESP32S3_PERIPH_I2C_EXT0,
  .irq        = BOSS1_ESP32S3_IRQ_I2C_EXT0,
#endif
...
#endif /* CONFIG_BOSS1_ESP32S3_I2C0 */

#ifdef CONFIG_BOSS1_ESP32S3_I2C1
static const struct esp32s3_i2c_config_s g_esp32s3_i2c1_config =
{
  .clk_freq   = I2C_CLK_FREQ_DEF,
  .scl_pin    = CONFIG_BOSS1_ESP32S3_I2C1_SCLPIN,
  .sda_pin    = CONFIG_BOSS1_ESP32S3_I2C1_SDAPIN,
#ifndef CONFIG_I2C_POLLED
  .periph     = BOSS1_ESP32S3_PERIPH_I2C_EXT1,
  .irq        = BOSS1_ESP32S3_IRQ_I2C_EXT1,
#endif
...
#endif /* CONFIG_BOSS1_ESP32S3_I2C1 */
...
struct i2c_master_s *esp32s3_i2cbus_initialize(int port)
{
  ...
  switch (port)
    {
#ifdef CONFIG_BOSS1_ESP32S3_I2C0
      case BOSS1_ESP32S3_I2C0:
        priv = &g_esp32s3_i2c0_priv;
        break;
#endif
#ifdef CONFIG_BOSS1_ESP32S3_I2C1
      case BOSS1_ESP32S3_I2C1:
...
#endif /* CONFIG_BOSS1_ESP32S3_I2C */
