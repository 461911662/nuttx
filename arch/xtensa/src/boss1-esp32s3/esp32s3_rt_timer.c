...
#define RT_TIMER_TASK_NAME        CONFIG_BOSS1_ESP32S3_RT_TIMER_TASK_NAME
#define RT_TIMER_TASK_PRIORITY    CONFIG_BOSS1_ESP32S3_RT_TIMER_TASK_PRIORITY
#define RT_TIMER_TASK_STACK_SIZE  CONFIG_BOSS1_ESP32S3_RT_TIMER_TASK_STACK_SIZE
      ...
      if (priv->cpuint != -ENOMEM)
        {
          ...
          up_disable_irq(BOSS1_ESP32S3_IRQ_SYSTIMER_TARGET2);
          esp32s3_teardown_irq(priv->core, BOSS1_ESP32S3_PERIPH_SYSTIMER_TARGET2,
                               priv->cpuint);
          irq_detach(BOSS1_ESP32S3_IRQ_SYSTIMER_TARGET2);
  ...
  /* Otherwise set callback and enable interrupt */
  ...
  else
    {
      ...
      priv->cpuint = esp32s3_setup_irq(priv->core,
                                       BOSS1_ESP32S3_PERIPH_SYSTIMER_TARGET2,
      ...
      ret = irq_attach(BOSS1_ESP32S3_IRQ_SYSTIMER_TARGET2, handler, arg);
      if (ret != OK)
        {
          esp32s3_teardown_irq(priv->core, BOSS1_ESP32S3_PERIPH_SYSTIMER_TARGET2,
                               priv->cpuint);
      ...
      up_enable_irq(BOSS1_ESP32S3_IRQ_SYSTIMER_TARGET2);
    }
