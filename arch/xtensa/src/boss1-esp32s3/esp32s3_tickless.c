...
#define BOSS1_ESP32S3_SYSTIMER_TICKS_PER_SEC  (16 * 1000 * 1000)

#define CTICK_PER_SEC         (BOSS1_ESP32S3_SYSTIMER_TICKS_PER_SEC)
...
void up_timer_initialize(void)
{
  ...
  cpuint = esp32s3_setup_irq(0, BOSS1_ESP32S3_PERIPH_SYSTIMER_TARGET0, 1,
  ...
  irq_attach(BOSS1_ESP32S3_IRQ_SYSTIMER_TARGET0, tickless_isr, NULL);

  /* Enable the allocated CPU interrupt. */

  up_enable_irq(BOSS1_ESP32S3_IRQ_SYSTIMER_TARGET0);
