...
#ifndef __ARCH_XTENSA_SRC_BOSS1_ESP32S3_BOSS1_ESP32S3_WDT_H
#define __ARCH_XTENSA_SRC_BOSS1_ESP32S3_BOSS1_ESP32S3_WDT_H
...
#define BOSS1_ESP32S3_WDT_START(d)                  ((d)->ops->start(d))
#define BOSS1_ESP32S3_WDT_STOP(d)                   ((d)->ops->stop(d))
#define BOSS1_ESP32S3_WDT_LOCK(d)                   ((d)->ops->enablewp(d))
#define BOSS1_ESP32S3_WDT_UNLOCK(d)                 ((d)->ops->disablewp(d))
#define BOSS1_ESP32S3_MWDT_PRE(d, v)                ((d)->ops->pre(d, v))
#define BOSS1_ESP32S3_XTWDT_PRE(d, v)               ((d)->ops->pre(d, v))
#define BOSS1_ESP32S3_WDT_STO(d, v, s)              ((d)->ops->settimeout(d, v, s))
#define BOSS1_ESP32S3_WDT_FEED(d)                   ((d)->ops->feed(d))
#define BOSS1_ESP32S3_WDT_STG_CONF(d, s, c)         ((d)->ops->stg_conf(d, s, c))
#define BOSS1_ESP32S3_RWDT_CLK(d)                   ((d)->ops->rtc_clk(d))
#define BOSS1_ESP32S3_XTWDT_CLK(d)                  ((d)->ops->rtc_clk(d))
#define BOSS1_ESP32S3_WDT_SETISR(d, hnd, arg)       ((d)->ops->setisr(d, hnd, arg))
#define BOSS1_ESP32S3_WDT_ENABLEINT(d)              ((d)->ops->enableint(d))
#define BOSS1_ESP32S3_WDT_DISABLEINT(d)             ((d)->ops->disableint(d))
#define BOSS1_ESP32S3_WDT_ACKINT(d)                 ((d)->ops->ackint(d))
#define BOSS1_ESP32S3_XTWDT_RST_CLK(d)              ((d)->ops->rstclk(d))
...
{
  BOSS1_ESP32S3_WDT_MWDT0 = 0,  /* Main System Watchdog Timer (MWDT) of Timer Group 0 */
  BOSS1_ESP32S3_WDT_MWDT1,      /* Main System Watchdog Timer (MWDT) of Timer Group 1 */
  BOSS1_ESP32S3_WDT_RWDT,       /* RTC Watchdog Timer (RWDT) */
  BOSS1_ESP32S3_WDT_XTWDT       /* XTAL32K Watchdog Timer (XTWDT) */
};
...
{
  BOSS1_ESP32S3_WDT_STAGE0 = 0,     /* Stage 0 */
  BOSS1_ESP32S3_WDT_STAGE1 = 1,     /* Stage 1 */
  BOSS1_ESP32S3_WDT_STAGE2 = 2,     /* Stage 2 */
  BOSS1_ESP32S3_WDT_STAGE3 = 3      /* Stage 3 */
};
...
{
  BOSS1_ESP32S3_WDT_STAGE_ACTION_OFF = 0,           /* Disabled. This stage will have no effects on the system. */
  BOSS1_ESP32S3_WDT_STAGE_ACTION_INT = 1,           /* Trigger an interrupt when the stage expires. */
  BOSS1_ESP32S3_WDT_STAGE_ACTION_RESET_CPU = 2,     /* Reset a CPU core when the stage expires. */
  BOSS1_ESP32S3_WDT_STAGE_ACTION_RESET_SYSTEM = 3,  /* Reset the main system when the stage expires.
                                               * This includes the CPU and all peripherals.
                                               * The RTC is an exception and will not be reset.
                                               */
  BOSS1_ESP32S3_WDT_STAGE_ACTION_RESET_RTC = 4      /* Reset the main system and the RTC when the stage expires.
...
#endif /* __ARCH_XTENSA_SRC_BOSS1_ESP32S3_BOSS1_ESP32S3_WDT_H */
