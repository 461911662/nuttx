...
#ifdef CONFIG_BOSS1_ESP32S3_SPI_SWCS
...
#  if (CONFIG_BOSS1_ESP32S3_SPI_DMA_BUFSIZE % BOSS1_ESP32S3_DMA_BUFLEN_MAX) > 0
#    define SPI_DMA_DESC_NUM (CONFIG_BOSS1_ESP32S3_SPI_DMA_BUFSIZE / BOSS1_ESP32S3_DMA_BUFLEN_MAX + 1)
#  else
#    define SPI_DMA_DESC_NUM (CONFIG_BOSS1_ESP32S3_SPI_DMA_BUFSIZE / BOSS1_ESP32S3_DMA_BUFLEN_MAX)
#  endif
...
#ifndef CONFIG_BOSS1_ESP32S3_SPI_UDCS
...
#ifdef CONFIG_BOSS1_ESP32S3_SPI_UDCS
...
#ifndef CONFIG_BOSS1_ESP32S3_SPI_SWCS
 ...
 *
 *   If BOSS1_ESP32S3_SPI_SWCS is disabled, the driver will use hardware CS so that
...
#ifdef CONFIG_BOSS1_ESP32S3_SPI_DMA
  size_t thld = CONFIG_BOSS1_ESP32S3_SPI_DMATHRESHOLD;
