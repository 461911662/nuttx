...
#  undef  CONSOLE_DEV
#  if defined(CONFIG_BOSS1_ESP32S3_UART0)
#    define TTYS0_DEV           g_uart0_dev  /* UART0 is ttyS0 */
#    define UART0_ASSIGNED      1
#  elif defined(CONFIG_BOSS1_ESP32S3_UART1)
#    define TTYS0_DEV           g_uart1_dev  /* UART1 is ttyS0 */
#    define UART1_ASSIGNED      1
#  elif defined(CONFIG_BOSS1_ESP32S3_UART2)
#    define TTYS0_DEV           g_uart2_dev  /* UART2 is ttyS0 */
#    define UART2_ASSIGNED      1
#  endif
#endif /* CONSOLE_UART */
...
#if defined(CONFIG_BOSS1_ESP32S3_UART0) && !defined(UART0_ASSIGNED)
#  define TTYS1_DEV           g_uart0_dev  /* UART0 is ttyS1 */
#  define UART0_ASSIGNED      1
#elif defined(CONFIG_BOSS1_ESP32S3_UART1) && !defined(UART1_ASSIGNED)
#  define TTYS1_DEV           g_uart1_dev  /* UART1 is ttyS1 */
#  define UART1_ASSIGNED      1
#elif defined(CONFIG_BOSS1_ESP32S3_UART2) && !defined(UART2_ASSIGNED)
...
#endif /* CONFIG_BOSS1_ESP32S3_UART */
