...
#if defined(CONFIG_BOSS1_ESP32S3_SPI) && defined(CONFIG_SPI_SLAVE)
...
#ifdef CONFIG_BOSS1_ESP32S3_SPI_DMA
...
#define SPI_SLAVE_BUFSIZE (CONFIG_BOSS1_ESP32S3_SPI_SLAVE_BUFSIZE)

#ifdef CONFIG_BOSS1_ESP32S3_SPI_DMA
/* SPI DMA RX/TX number of descriptors */

#  if (SPI_SLAVE_BUFSIZE % BOSS1_ESP32S3_DMA_BUFLEN_MAX) > 0
#    define SPI_DMA_DESC_NUM (SPI_SLAVE_BUFSIZE / BOSS1_ESP32S3_DMA_BUFLEN_MAX + 1)
#  else
#    define SPI_DMA_DESC_NUM (SPI_SLAVE_BUFSIZE / BOSS1_ESP32S3_DMA_BUFLEN_MAX)
#  endif
...
#endif /* CONFIG_BOSS1_ESP32S3_SPI_DMA */
...
#  define SPI_IS_CS_IOMUX   (CONFIG_BOSS1_ESP32S3_SPI2_CSPIN == SPI2_IOMUX_CSPIN)
#  define SPI_IS_CLK_IOMUX  (CONFIG_BOSS1_ESP32S3_SPI2_CLKPIN == SPI2_IOMUX_CLKPIN)
#  define SPI_IS_MOSI_IOMUX (CONFIG_BOSS1_ESP32S3_SPI2_MOSIPIN == SPI2_IOMUX_MOSIPIN)
#  define SPI_IS_MISO_IOMUX (CONFIG_BOSS1_ESP32S3_SPI2_MISOPIN == SPI2_IOMUX_MISOPIN)
...
#  ifdef CONFIG_BOSS1_ESP32S3_SPI_IO_QIO
#    define SPI_IS_IO2_IOMUX  (CONFIG_BOSS1_ESP32S3_SPI2_IO2PIN == SPI2_IOMUX_WPPIN)
#    define SPI_IS_IO3_IOMUX  (CONFIG_BOSS1_ESP32S3_SPI2_IO3PIN == SPI2_IOMUX_HDPIN)
...
static const struct spislave_config_s esp32s3_spi2slave_config =
{
  ...
  .id           = 2,
  .cs_pin       = CONFIG_BOSS1_ESP32S3_SPI2_CSPIN,
  .mosi_pin     = CONFIG_BOSS1_ESP32S3_SPI2_MOSIPIN,
  .miso_pin     = CONFIG_BOSS1_ESP32S3_SPI2_MISOPIN,
  .clk_pin      = CONFIG_BOSS1_ESP32S3_SPI2_CLKPIN,
#ifdef CONFIG_BOSS1_ESP32S3_SPI_IO_QIO
  .io2_pin      = CONFIG_BOSS1_ESP32S3_SPI2_IO2PIN,
  .io3_pin      = CONFIG_BOSS1_ESP32S3_SPI2_IO3PIN,
#endif
  .periph       = BOSS1_ESP32S3_PERIPH_SPI2,
  .irq          = BOSS1_ESP32S3_IRQ_SPI2,
  .clk_bit      = SYSTEM_SPI2_CLK_EN,
  .rst_bit      = SYSTEM_SPI2_RST,
#ifdef CONFIG_BOSS1_ESP32S3_SPI_DMA
  .dma_clk_bit  = SYSTEM_SPI2_DMA_CLK_EN,
  .dma_rst_bit  = SYSTEM_SPI2_DMA_RST,
  .dma_periph   = BOSS1_ESP32S3_DMA_PERIPH_SPI2,
#endif
...
#endif /* CONFIG_BOSS1_ESP32S3_SPI2 */
...
static const struct spislave_config_s esp32s3_spi3slave_config =
{
  ...
  .mode         = SPI_SLAVE_DEFAULT_MODE,
  .id           = 3,
  .cs_pin       = CONFIG_BOSS1_ESP32S3_SPI3_CSPIN,
  .mosi_pin     = CONFIG_BOSS1_ESP32S3_SPI3_MOSIPIN,
  .miso_pin     = CONFIG_BOSS1_ESP32S3_SPI3_MISOPIN,
  .clk_pin      = CONFIG_BOSS1_ESP32S3_SPI3_CLKPIN,
#ifdef CONFIG_BOSS1_ESP32S3_SPI_IO_QIO
  .io2_pin      = CONFIG_BOSS1_ESP32S3_SPI3_IO2PIN,
  .io3_pin      = CONFIG_BOSS1_ESP32S3_SPI3_IO3PIN,
#endif
  .periph       = BOSS1_ESP32S3_PERIPH_SPI3,
  .irq          = BOSS1_ESP32S3_IRQ_SPI3,
  .clk_bit      = SYSTEM_SPI3_CLK_EN,
  .rst_bit      = SYSTEM_SPI3_RST,
#ifdef CONFIG_BOSS1_ESP32S3_SPI_DMA
  .dma_clk_bit  = SYSTEM_SPI3_DMA_CLK_EN,
  .dma_rst_bit  = SYSTEM_SPI3_DMA_RST,
  .dma_periph   = BOSS1_ESP32S3_DMA_PERIPH_SPI3,
#endif
...
#endif /* CONFIG_BOSS1_ESP32S3_SPI3 */
...
#ifndef CONFIG_BOSS1_ESP32S3_SPI_DMA
static void spislave_write_tx_buffer(struct spislave_priv_s *priv)
{
...
#ifndef CONFIG_BOSS1_ESP32S3_SPI_IO_QIO
...
#if SPI_VIA_IOMUX == 0 || defined(CONFIG_BOSS1_ESP32S3_SPI3)
...
static int spislave_initialize(struct spi_slave_ctrlr_s *ctrlr)
{
  ...
  esp32s3_gpioirqenable(BOSS1_ESP32S3_PIN2IRQ(config->cs_pin), RISING);
...
static void spislave_deinitialize(struct spi_slave_ctrlr_s *ctrlr)
{
  ...
  esp32s3_gpioirqdisable(BOSS1_ESP32S3_PIN2IRQ(priv->config->cs_pin));
...
struct spi_slave_ctrlr_s *esp32s3_spislave_ctrlr_initialize(int port)
{
  ...
  switch (port)
    {
#ifdef CONFIG_BOSS1_ESP32S3_SPI2
      case BOSS1_ESP32S3_SPI2:
        priv = &esp32s3_spi2slave_priv;
        break;
#endif
#ifdef CONFIG_BOSS1_ESP32S3_SPI3
      case BOSS1_ESP32S3_SPI3:
  ...
  DEBUGVERIFY(irq_attach(BOSS1_ESP32S3_PIN2IRQ(priv->config->cs_pin),
...
#endif /* defined(CONFIG_BOSS1_ESP32S3_SPI) && defined (CONFIG_SPI_SLAVE) */
