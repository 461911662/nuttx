...
{
  .port             = 0,
#ifdef CONFIG_BOSS1_ESP32_I2S0_ROLE_MASTER
  .role             = I2S_ROLE_MASTER,
#else
  .role             = I2S_ROLE_SLAVE,
#endif /* CONFIG_BOSS1_ESP32_I2S0_ROLE_MASTER */
...
{
  .port             = 1,
#ifdef CONFIG_BOSS1_ESP32_I2S1_ROLE_MASTER
  .role             = I2S_ROLE_MASTER,
#else
  .role             = I2S_ROLE_SLAVE,
#endif /* CONFIG_BOSS1_ESP32_I2S1_ROLE_MASTER */
